...
ALTER TABLE "public"."#####newsmanager"
  DROP COLUMN "use_feeds";

ALTER TABLE "public"."#####imagegallery_config"
  ADD COLUMN "image_sort" VARCHAR(4);

ALTER TABLE "public"."#####sidebar_extensions"
  ADD COLUMN "show_memberlist" INTEGER;

ALTER TABLE "public"."#####news_categories"
  ALTER COLUMN "uid" TYPE VARCHAR(10);
