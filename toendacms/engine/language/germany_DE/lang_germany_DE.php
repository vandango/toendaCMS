...
define('_TCMS_ADMIN_VOTE', 'Jetzt abstimmen!');
define('_TCMS_ADMIN_NEW', 'Neu');
define('_TCMS_ADMIN_IMPORT', 'Import');
define('_TCMS_ADMIN_CREATE', 'Neues Album erstellen...');
define('_TCMS_ADMIN_NEW_POLL', 'Neue Umfrage erstellen...');
define('_TCMS_ADMIN_NEW_ITEM', 'Neuen Eintrag erstellen...');
define('_TCMS_ADMIN_NEW_USER', 'Neuen Benutzer erstellen...');
define('_TCMS_ADMIN_NEW_CATEGORY', 'Neue Kategorie erstellen...');
...
define('_TCMS_ADMIN_RIGHT', 'Alle Rechte vorbehalten.');
define('_TCMS_ADMIN_LOGED', 'Angemeldet als');
define('_TCMS_ADMIN_GOTOSITE', 'Zur Frontseite wechseln');
...
define('_TCMS_MONTH_FEBUARY', 'Februar');
...
define('_TCMS_MONTH_DECEMBER', 'Dezember');
define('_TCMS_DAY_MONDAY', 'Montag');
define('_TCMS_DAY_TUESDAY', 'Dienstag');
define('_TCMS_DAY_WEDNESDAY', 'Mittwoch');
define('_TCMS_DAY_THURSDAY', 'Donnerstag');
define('_TCMS_DAY_FRIDAY', 'Freitag');
define('_TCMS_DAY_SATURDAY', 'Samstag');
define('_TCMS_DAY_SUNDAY', 'Sonntag');
define('_TCMS_DAY_MONDAY_XS', 'Mon');
define('_TCMS_DAY_TUESDAY_XS', 'Die');
define('_TCMS_DAY_WEDNESDAY_XS', 'Mit');
define('_TCMS_DAY_THURSDAY_XS', 'Don');
define('_TCMS_DAY_FRIDAY_XS', 'Fri');
define('_TCMS_DAY_SATURDAY_XS', 'Sam');
define('_TCMS_DAY_SUNDAY_XS', 'Son');
define('_TCMS_COLOR', 'Farbe');
define('_TCMS_TODAY', 'Heute');
define('_TCMS_BACKGROUND', 'Hintergrund');
...
define('_TCMS_TOPMENU_MANAGE', 'Verwaltung');
define('_TCMS_TOPMENU_NAVIGATION', 'Navigation');
define('_TCMS_TOPMENU_SETTINGS', 'Einstellungen');
define('_TCMS_TOPMENU_CONTENT', 'Inhalte');
define('_TCMS_TOPMENU_SIDEBAR', 'Seitenleiste');
define('_TCMS_TOPMENU_EXTENSIONS', 'Erweiterungen');
define('_TCMS_TOPMENU_COMPONENTS', 'Komponenten');
define('_TCMS_TOPMENU_SITE', 'Seite');
define('_TCMS_TOPMENU_HELP', 'Hilfe');
define('_TCMS_TOPMENU_CONF_MODULE', 'Modul Konfiguration');


// TCMS
define('_TCMS_MENU_HOME', 'Home');
define('_TCMS_MENU_LOGOUT', 'Abmelden');
define('_TCMS_MENU_PAGE', 'Schreibtisch');
define('_TCMS_MENU_FILE', 'Dateimanager');
...
define('_TCMS_MENU_CONTENT', 'Dokumente');
define('_TCMS_MENU_NEWS', 'Neuigkeiten');
define('_TCMS_MENU_DOWN', 'Downloads');
define('_TCMS_MENU_PRODUCTS', 'Produkte');
define('_TCMS_MENU_FAQ', 'Artikel und FAQs');
define('_TCMS_MENU_SIDEEXT', 'Erweiterungen');
define('_TCMS_MENU_SIDE', 'Seitenleiste');
define('_TCMS_MENU_NEWSLETTER', 'Newsletter');
define('_TCMS_MENU_POLL', 'Umfrage');
define('_TCMS_MENU_EXT', 'Erweiterungen');
define('_TCMS_MENU_FRONT', 'Startseite');
define('_TCMS_MENU_GALLERY', 'Bildergalerie');
define('_TCMS_MENU_LINK', 'Links');
define('_TCMS_MENU_IMP', 'Impressum');
define('_TCMS_MENU_CONTACT', 'Kontaktmanager');
...
define('_TCMS_MENU_THEME_PREVIEW', 'Vorschau');
define('_TCMS_MENU_COPY', 'Lizenz');
...
define('_MOD_PAGE', 'Webseiten Modul');
define('_MOD_EXPLORE', 'Dateimanager - Verwalten Sie Ihren erstellten Datenbestand');
...
define('_MOD_TOPMENU', 'Topmenu verwalten');
define('_MOD_USERMENU', 'Benutzermenu verwalten');
define('_MOD_MENUTITLE', 'Menutitel verwalten');
define('_MOD_CONTENT', 'Dokumente verwalten');
define('_MOD_NEWS', 'Neuigkeiten verwalten');
define('_MOD_DOWN', 'Downloads verwalten');
define('_MOD_PRODUCTS', 'Produkte verwalten');
define('_MOD_SIDEBAR_EXTENSION', 'Konfiguration der Erweiterungen');
define('_MOD_SIDEBAR', 'Statische Inhalte der Seitenleiste verwalten');
...
define('_MOD_LINK', 'Links verwalten');
define('_MOD_KNOWLEDGEBASE', 'Artikel und FAQ\'s verwalten');
define('_MOD_CONTACT', 'Kontakte verwalten');
define('_MOD_USER', 'Benutzer verwalten');
define('_MOD_USERPAGE', 'Editorseiten Konfiguration');
define('_MOD_COMPONENTS', 'Komponentensystem');
define('_MOD_COMPONENTS_UPLOAD', 'Komponenten Installations und Bearbeitungs Manager');
define('_MOD_GLOBAL', 'Systemeinstellungen');
define('_MOD_IMPORT', 'Import');
define('_MOD_DB', 'Datenbankeinstellungen');
define('_MOD_STATS', 'Webseiten Statistiken');
define('_MOD_TEMPLATE', 'Vorlagenmanager');
define('_MOD_TEMPLATE_UPLOAD', 'Vorlagen Installations und Bearbeitungs Manager');
define('_MOD_LICENSE', 'toendaCMS Lizenz (GNU/GPL)');
define('_MOD_HELP', 'Hilfe zu verschiedenen Modulen und Einstellungen');
...
define('_TABLE_FILE_EXISTS_NAME', 'Vorhandene Datei');
define('_TABLE_FILE_OTHERURL_NAME', 'Datei auf anderem Server');
define('_TABLE_DATE', 'Datum');
define('_TABLE_TIME', 'Zeit');
define('_TABLE_EMAIL', 'eMail');
define('_TABLE_OPTION', 'Option');
define('_TABLE_INFO', 'Informationen');
define('_TABLE_ORDER_HELP', '(Identifikations Nummer)');
define('_TABLE_ALBUM', 'Album');
define('_TABLE_DIR', 'Ordner');
define('_TABLE_BACKENDFILE', 'Administrationsdatei');
define('_TABLE_FRONTENDFILE', 'Webseitendatei');
...
define('_TABLE_SETTINGS', 'Einstellungen');
define('_TABLE_CONTACT', 'Kontakt Informationen');
...
define('_TABLE_EDITBUTTON', 'Bearbeiten');
...
define('_TABLE_USERMENU', 'Benutzermenu');
define('_TABLE_SUBMENU', 'Submenu');
define('_TABLE_CHARSET', 'Zeichensatz');
define('_TABLE_ALIAS', 'Alias');
define('_TABLE_LEFT', 'Links');
define('_TABLE_RIGHT', 'Rechts');
define('_TABLE_CENTER', 'Zentriert');
define('_TABLE_TYPE', 'Typ/Art');
define('_TABLE_MENUTITLE', 'Menutitel');
...
define('_TABLE_OF', 'von');
define('_TABLE_ENABLED_THIS', 'Aktivieren');
define('_TABLE_DISABLED_THIS', 'Deaktivieren');
define('_TABLE_IP', 'IP');
define('_TABLE_DOMAIN', 'Domain');
define('_TABLE_SIDEBAR', 'Seitenleiste');
define('_TABLE_MAINCONTENT', 'Hauptseite');
define('_TABLE_BOTH', 'Beide');
define('_TABLE_FILTER', 'Filter und Einstellungen');
define('_TABLE_SORT_SIDE', 'Position Seitenleiste');
define('_TABLE_LOCATION', 'Ort');
...
define('_TABLE_DIARY_TICKET', 'Kartenverkauf');
define('_TABLE_IMPORT', 'Import');
define('_TABLE_SORT', 'Sortierung');
define('_TABLE_SORT_DESC', 'Absteigende Sortierung');
...
define('_MSG_NOTWRITABLE', 'IST NICHT BESCHREIBBAR!');
define('_MSG_NOINSTALL', 'Bitte erst installieren!');
define('_MSG_GOTOINSTALL', 'ZUR INSTALLATION');
define('_MSG_RM_INSTALLDIR', 'Bitte entfernen Sie den Installationsordner!');
define('_MSG_PAGE_LOAD_1', 'Seite in');
define('_MSG_PAGE_LOAD_2', 'Sekunden erstellt');
define('_MSG_NOIMAGE', 'Kein Bild ausgewaehlt.');
define('_MSG_IMAGE', 'Bild erfolgreich hochgeladen in Pfad:');
define('_MSG_NONAME', 'Keinen Namen eingegeben');
define('_MSG_NOCAPTCHA', 'Bitte geben Sie den angezeigten Code aus dem Bild ein');
define('_MSG_CAPTCHA_NOT_VALID', 'Ihr eingegebener Code und der Code im Bild stimmen nicht ueberein.');
define('_MSG_FALSEPASSWORD', 'Falsches Passwort eingegeben!');
define('_MSG_PASSWORDNOTVALID', 'Passwoerter stimmen nicht ueberein!');
...
define('_MSG_POLL', 'Vielen Dank, dass Sie an dieser Umfrage teilgenommen haben.');
...
define('_MSG_NOACCOUNT', 'Sie haben noch keinen Account.');
define('_MSG_NOCONTENT', 'Sie haben nicht alle benoetigten Felder ausgefuellt.');
...
define('_MSG_IF_DOWNLOAD_DOES_NOT_START', 'Falls der Download nicht automatisch starten sollte, klicken Sie bitte den folgenden Link');
define('_MSG_BACKUP_SUCCESSFULL', 'Das Datenbank Backup ist erfolgreich abgeschlossen.\nBetroffene Tabellen:');
define('_MSG_BACKUP_FAILED', 'Das Datenbank Backup ist fehlgeschlagen!');
...
define('_MSG_ACTIVATE_NEW_PW_FIRST', 'Sie m&#252;ssen Ihr neues Passwort erst aktivieren, nutzen Sie dazu bitte folgenden Link:');
...
define('_LOGIN_USERNAME_JS', 'Bitte geben Sie Ihren Benutzernamen ein!');
define('_LOGIN_PASSWORD', 'Passwort');
define('_LOGIN_PASSWORD_JS', 'Bitte geben Sie Ihr Passwort ein!');
define('_LOGIN_FALSE', 'Falsche Eingabe: Benutzername, Passwort oder Benutzerrechte (Gruppe)');
define('_LOGIN_FALSE_LPW', 'Falsche Eingabe: Benutzername oder eMail');
define('_LOGIN_SUBMIT', 'Login');
define('_LOGIN_LOGOUT', 'Ausloggen');
define('_LOGIN_PROFILE', 'Profil');
define('_LOGIN_LIST', 'Mitgliederliste');
define('_LOGIN_LIST_TEXT', 'Dies ist die Liste aller Mitglieder. Sie k&#246;nnen auf einen Benutzernamen klicken um sich dessen Profil anzuschauen.');
define('_LOGIN_ADMIN', 'Administration');
define('_LOGIN_FORGOTPW', 'Das Passwort vergessen?');
define('_LOGIN_WELCOME', 'Willkommen');
define('_LOGIN_SUBMIT_NEWS', 'Neuigkeit schreiben');
define('_LOGIN_SUBMIT_IMAGES', 'Bilder hochladen');
define('_LOGIN_CREATE_ALBUM', 'Album erstellen');
define('_LOGIN_CREATE_CATEGORY', 'Kategorie erstellen');
define('_LOGIN_SUBMIT_MEDIA', 'Medien hochladen');
...
define('_REG_EMAIL_NG', 'Keine eMail eingegeben!');
define('_REG_LPW_SUCCESS', 'Ihr neues Passwort');
define('_REG_SUCCESS', 'Ihre Registrierung war erfolgreich.');
...
// PROFILE
define('_PROFILE_TITLE', 'Benutzerprofil anschauen');
define('_PROFILE_EDIT', 'Benutzerprofil bearbeiten');
...
define('_MENUTITLE_TEXT', 'Die Positions-Nummer bestimmt die Stelle im Menu.');
...
// IMPRESSUM
define('_IMPRESSUM_CONFIG', 'Impressum Konfiguration');
...
define('_IMPRESSUM_FAX', 'Telefax');
define('_IMPRESSUM_CONTACTPERSON', 'Ansprechpartner');
define('_IMPRESSUM_OFFICE', 'Anschrift');
define('_IMPRESSUM_EMAIL', 'eMail');
define('_IMPRESSUM_COPY', 'Alle Rechte vorbehalten.');
define('_IMPRESSUM_SITECOPY', 'Der Inhalt dieser Seite unterliegt dem Copyright von');
...
// GROUPS
define('_GROUP_DEV', 'Entwickler und Betreiber');
define('_GROUP_ADMIN', 'Administrator');
define('_GROUP_WRITER', 'Erweiterter Redakteur');
define('_GROUP_EDITOR', 'Einfacher Redakteur');
define('_GROUP_PRESENTER', 'Moderator des Forums');
define('_GROUP_USER', 'Benutzer der Seite');


// TCMS SCRIPT
define('_TCMSSCRIPT_BR', 'Zeilenumbruch');
define('_TCMSSCRIPT_MORE', 'Eigene Neuigkeiten Ende');
define('_TCMSSCRIPT_IMAGES', 'Bilder suchen');
...
// EXPLORER
define('_EXPLORE_UP', 'Eintrag nach oben verschieben.');
define('_EXPLORE_DOWN', 'Eintrag nach unten verschieben.');
...
// EXTENSION
define('_EXT_NEWS', 'Neuigkeiten Manager');
define('_EXT_NEWS_NEWSAMOUNT', 'Anzahl der Neuigkeiten im Manager (nicht im Archiv)');
define('_EXT_NEWS_ID', 'ID');
define('_EXT_NEWS_TITLE', 'Neuigkeit Titel');
define('_EXT_NEWS_SUBTITLE', 'Neuigkeit Untertitel');
define('_EXT_NEWS_IMAGE', 'Neuigkeit Bild');
define('_EXT_NEWS_USE_COMMENTS', 'Kommentare zu Neuigkeiten zulassen');
define('_EXT_NEWS_USE_EMOTICONS', 'Grafik-Smileys in den Kommentaren zulassen');
define('_EXT_NEWS_D_TIMESINCE', 'Timesince');
define('_EXT_NEWS_D_DATE', 'Normales Datum');
...
define('_EXT_NEWS_USE_RSS10', 'RSS 1.0 verwenden');
define('_EXT_NEWS_USE_RSS20', 'RSS 2.0 verwenden');
define('_EXT_NEWS_USE_ATOM03', 'ATOM 0.3 verwenden');
define('_EXT_NEWS_USE_OPML', 'OPML verwenden');
define('_EXT_NEWS_SYN_AMOUNT', 'Wie viele Neuigkeiten in den Feeds?');
define('_EXT_NEWS_USE_SYN_TITLE', 'Syndication Titel in Seitenleiste ');
define('_EXT_NEWS_DEFAULT_FEED', 'Voreingestellter Syndication Feed');
define('_EXT_NEWS_USE_TRACKBACK', 'Trackback benutzen');
define('_EXT_CFORM', 'Kontaktformular');
define('_EXT_CFORM_SHOW_CONTACTS_IN_SIDEBAR', 'Kontakte in Seitenleiste anzeigen');
define('_EXT_CFORM_USE_ADRESSBOOK', 'Adressbuch benutzen');
define('_EXT_CFORM_USE_CONTACTPERSON', 'Kontaktperson anzeigen');
...
// IMAGEGALLERY
define('_GALLERY_CONFIG', 'Bildergalerie Konfiguration');
define('_GALLERY_ID', 'ID');
define('_GALLERY_COMMENTS', 'Kommentare benutzen');
define('_GALLERY_FRONT_TITLE', 'Galerie Titel');
define('_GALLERY_FRONT_SUBTITLE', 'Galerie Untertitel');
define('_GALLERY_CREATE', 'Erstelle ein neues Album');
define('_GALLERY_NEW', 'Neues Album');
define('_GALLERY_DESCRIPTION', 'Beschreibung');
...
define('_PERSON_USERNAME', 'Benutzername');
define('_PERSON_POSITION', 'Position');
define('_PERSON_OCCUPATION', 'Beruf');
define('_PERSON_GROUP', 'Benutzergruppe');
define('_PERSON_JOINDATE', 'Angemeldet am');
define('_PERSON_RIGHTS', 'Benutzerrechte');
define('_PERSON_EMAIL', 'eMail Adresse');
define('_PERSON_PASSWORD', 'Passwort');
define('_PERSON_AS_MD5', 'MD5 Zeichenkette');
define('_PERSON_VPASSWORD', 'Passwort wiederholen');
define('_PERSON_STREET', 'Strasse');
define('_PERSON_STATE', 'Bundesland');
define('_PERSON_TOWN', 'Stadt');
define('_PERSON_COUNTRY', 'Land');
define('_PERSON_POSTAL', 'Postleitzahl');
define('_PERSON_PHONE', 'Telefon');
define('_PERSON_FAX', 'Telefax');
define('_PERSON_DETAILS', 'Ihre Details');
...
define('_PERSON_HOBBY', 'Interessen');
define('_PERSON_LOCATION', 'Wohnort');
define('_PERSON_LASTLOGIN', 'Letzter Besuch');


// SIDEBAR EXTENSION
define('_SIDEEXT_SIDEMENU', 'Seitenmenu');
define('_SIDEEXT_SIDEMENU_TITLE', 'Seitenmenu Titel');
define('_SIDEEXT_SIDEMENU_SHOW', 'Seitenmenu Titel anzeigen');
define('_SIDEEXT_SIDEBAR', 'Seitenleiste');
...
define('_SIDEEXT_SEARCH_RESULT_TITLE', 'Suchergebnis Titel');
define('_SIDEEXT_SEARCH_ALIGNMENT', 'Suchbox Ausrichtung');
define('_SIDEEXT_SEARCH_WITH_BR', 'Suchbutton darunter');
define('_SIDEEXT_SEARCH_WITH_BUTTON', 'Suchbutton anzeigen');
define('_SIDEEXT_SEARCH_WORD', 'Suchwort im Suchfeld');
define('_SIDEEXT_SEARCH_SHOW', 'Suche anzeigen');
define('_SIDEEXT_LOGIN', 'Login');
define('_SIDEEXT_LOGIN_TITLE', 'Login Titel');
define('_SIDEEXT_USERM_TITLE', 'Benutzermenu Titel');
...
define('_SIDEEXT_LOGIN_SHOW_TITLE', 'Login Titel zeigen');
define('_SIDEEXT_LOGIN_SHOW_MEMBERLIST', 'Mitgliederliste anzeigen');
define('_SIDEEXT_NEWS', 'Neuigkeiten');
define('_SIDEEXT_NEWS_CATEGORIES_SHOW', 'Neuigkeiten Kategorien anzeigen');
...
// NEWSLETTER
define('_NL_CONFIG', 'Newsletter Konfiguration');
define('_NL_TITLE', 'Newsletter Titel');
define('_NL_SHOW_TITLE', 'Newsletter Titel anzeigen');
define('_NL_TEXT', 'Newsletter Text');
define('_NL_SUBMIT', 'Newsletter Absenden-Knopf');
define('_NL_SHOW', 'Zeige Newsletter');
define('_NL_SEND', 'Sende einen Newsletter');
define('_NL_SUBJECT', 'Betreff');
define('_NL_MESSAGE', 'Nachricht');
define('_NL_USER', 'Zeige alle Newsletter Benutzer');
define('_NL_NEWUSER', 'Erstelle einen neuen Newsletter Benutzer.');
define('_NL_EDITUSER', 'Bearbeite Newsletter Benutzer.');
define('_NL_USERNAME', 'Ihr Name');
define('_NL_USEREMAIL', 'Name@eMail.eintragen');
define('_NL_MAILMESSAGE', 'Wenn Sie in Zukunft keinen Newsletter mehr erhalten moechten, antworten Sie im Betreff mit ');
define('_NL_CHECKSTRING', 'BITTE KEINEN NEWSLETTER');
define('_NL_CHECKFORUNSUBSCRIBE', 'eMails nach Abmelde-eMails abfragen');
...
// USER
define('_USER_TITLE', 'Benutzer anzeigen');
define('_USER_TEXT', 'Hier sehen Sie alle verfuegbaren Benutzer. Einige von ihnen sind Administratoren.');
define('_USER_SELF', 'Eigener Benutzername');
define('_USER_ALL', 'Alle Benutzer');
...
define('_CONTACT_VCARD_IMPORT_TEXT', 'Wenn sie eine .vcf Datei haben, laden sie diese hier hoch. toendaCMS wird den neuen Kontakt dann automatisch importieren.');
define('_CONTACT_VCARD_VCF', 'vCard .vcf Datei');
define('_CONTACT_VCARD_DOWNLOAD', 'vCard herunterladen');
...
define('_GLOBAL_EMAIL', 'Standard eMail');
define('_GLOBAL_YEAR', 'Copyright Jahr');
define('_GLOBAL_CHARSET', 'Zeichensatz');
define('_GLOBAL_LANG', 'Administrations Backend Sprache');
define('_GLOBAL_FRONT_LANG', 'Webseiten Sprache');
define('_GLOBAL_WYSIWYG', 'WYSIWYG-Editor benutzen');
...
define('_GLOBAL_MAIL_AS_HTML', 'eMails als HTML versenden');
define('_GLOBAL_MAIL_SERVER', 'eMailserver POP3');
define('_GLOBAL_MAIL_SERVER_SMTP', 'eMailserver SMTP');
define('_GLOBAL_MAIL_PORT', 'eMailserver Port');
define('_GLOBAL_MAIL_POP3', 'POP3');
define('_GLOBAL_MAIL_USER', 'eMail Benutzername');
define('_GLOBAL_MAIL_PASSWORD', 'eMail Passwort');
define('_GLOBAL_USE_STATISTICS', 'Statistiken benutzen');
define('_GLOBAL_USE_NEW_ADMINMENU', 'Neues Administrationsmenu verwenden');
...
// POLL
define('_POLL_MAINTITLE', 'Umfragemodul');
define('_POLL_ALL_TITLE', 'Alle Umfragen');
define('_POLL_TITLE', 'Umfragemodul Titel');
define('_POLL_SHOW_TITLE', 'Umfragetitel anzeigen');
define('_POLL_ALLPOLL_TITLES', 'Alle Umfragen Titel');
define('_POLL_SHOW', 'Zeige Umfrage in Seitenleiste');
define('_POLL_TITLE_SIDEMENU', 'Seitenmenu');
define('_POLL_MENU_TITLE', 'Link Titel');
define('_POLL_MENU_SHOW', 'Zeige Link');
define('_POLL_MENU_POS', 'An welcher Stelle');
define('_POLL_TITLE_TOPMENU', 'Topmenu');
define('_POLL_VOTETEXT', 'Danke das Sie abgestimmt haben.');
define('_POLL_RESULTTEXT', 'Sie haben bereits an dieser Umfrage teilgenommen.');
define('_POLL_ALLPOLLS', 'Alle Umfragen');
define('_POLL_RESULT', 'Ergebnis');
define('_POLL_POLLS_INACTIVE', 'Es sind zur Zeit keine Umfragen eingetragen.');
define('_POLL_SIDE_WIDTH', 'Breite der Umfrage in der Seitenbar');
define('_POLL_MAIN_WIDTH', 'Breite der Umfrage im Hauptbereich');
define('_POLL_ANSWERS', 'Stimmen');


// PATHWAY
define('_PATH_HOME', 'Home');
define('_PATH_REGISTRATION', 'Registrierung');
define('_PATH_PROFILE', 'Benutzer-Profil');
define('_PATH_POLLS', 'Umfragen');
define('_PATH_LOSTPW', 'Passwort vergessen');
...
define('_LAYOUT_PREVIEW', 'Vorschau');
define('_LAYOUT_CURRENT', 'Aktuelles Template');
define('_LAYOUT_COUNT', 'Installierte Templates');
...
define('_LU_ZFILE', 'Gepackte Datei (.zip)');
define('_LU_UPLOAD_TEMPLATE', 'Template Dateien in ein Verzeichnis hochladen');
...
define('_LU_DES_URL', 'Webseite des Autors');
...
define('_CREDITS_SERVER_FACE', 'PHP/Webserver Interface');
define('_CREDITS_RELEVANT_SET', 'Wichtige PHP Einstellungen');
define('_CREDITS_SET_GLOBALS', 'Register Globals');
define('_CREDITS_SET', 'installiert');
define('_CREDITS_PHP_MODULES', 'PHP Module');


// ABOUT MODULE
define('_ABOUTMOD_TITLE', 'Dies ist eine kurze Beschreibung der vorhandenen Module');
define('_ABOUTMOD_MODULE', 'Modul');
define('_ABOUTMOD_DESCRIPTION', 'Beschreibung');
...
define('_FORM_MESSAGE', 'Nachricht');
define('_FORM_URL', 'Webseite');
...
define('_FORM_THANKYOU', 'Wir danken fuer Ihren Besuch auf unserer Webseite!');
...
define('_BOOK_FILTER_SPAM', '@-Zeichen in eMailadressen zu [at] konvertieren');
define('_BOOK_WIDTH_NAME', 'Breite des Namenfeldes (in Pixel)');
...
// PRODUCTS
define('_PRODUCTS_TITLE', 'Produkte');
define('_PRODUCTS_ID', 'Produktseiten ID');
define('_PRODUCTS_SITETITLE', 'Produktseiten Titel');
define('_PRODUCTS_SITESUBTITLE', 'Produktseiten Untertitel');
...
define('_NEWS_DIR', 'Ordner');
define('_NEWS_ARCHIVE', 'Archiv');
define('_NEWS_ALL', 'Alle');
define('_NEWS_LAST', 'Letzten');
define('_NEWS_ORDER_BY_TIME', 'Chronologisch sortiert');
...
// FRONTAPAGE
define('_FRONTPAGE_CONFIG', 'Startseiten Konfiguration');
define('_FRONTPAGE_USE', 'Benutze Startseite');
define('_FRONTPAGE_ID', 'ID (wenn Sie die Startseite benutzen, ist ID 0)');
define('_FRONTPAGE_TITLE', 'Startseiten Titel');
define('_FRONTPAGE_SUBTITLE', 'Startseiten Untertitel');
define('_FRONTPAGE_TEXT', 'Startseiten Text');
define('_FRONTPAGE_NEWS', 'Neuigkeiten');
define('_FRONTPAGE_NEWS_TITLE', 'Neuigkeiten Titel');
define('_FRONTPAGE_NEWS_MUCH', 'Wie viele Neuigkeiten sollen auf der Startseite angezeigt werden?');
define('_FRONTPAGE_NEWS_CHARS', 'Wie viele Zeichen sollen von den Neuigkeiten vorab angezeigt werden?');
define('_FRONT_MORE', 'Weiterlesen');
define('_FRONT_COMMENT', 'Kommentar');
define('_FRONT_COMMENTS', 'Kommentare');
define('_FRONT_NOCOMMENT', 'Keine Kommentare eingetragen.');
define('_FRONT_COMMENT_TITLE', 'Schreiben Sie einen neuen Kommentar');
define('_FRONT_COMMENT_NAME', 'Name');
define('_FRONT_COMMENT_EMAIL', 'eMail');
define('_FRONT_COMMENT_WEB', 'Webseite');
define('_FRONT_COMMENT_TEXT', 'Nachricht');
define('_FRONT_COMMENT_POST', 'Geschrieben von');
define('_FRONT_OWN_TRACKBACK', 'Eigene Trackback URL');
define('_FRONT_TRACKBACK_URL', 'Trackback Ziel URL');
define('_FRONTPAGE_SIDEBAR_NEWS', 'Neuigkeiten in der Seitenleiste');
define('_FRONTPAGE_SIDEBAR_NEWS_USE', 'Zeige Neuigkeiten in der Seitenleiste');
define('_FRONTPAGE_SIDEBAR_NEWS_TITLE', 'Titel der Neuigkeiten in der Seitenleiste');
define('_FRONTPAGE_SIDEBAR_NEWS_MUCH', 'Wie viele Neuigkeiten sollen in der Seitenleiste angezeigt werden?');
define('_FRONTPAGE_NEWS_DISPLAY', 'Wie sollen die Neuigkeiten in der Seitenleiste dargestellt werden?');
...
define('_FOLDER_LOCKED', 'Geschlossen');
define('_FOLDER_PACK', 'Software/Pakete');
define('_FOLDER_PRINT', 'Druck');
define('_FOLDER_SOUND', 'Musik');
define('_FOLDER_DOCU', 'Dokumente');
...
define('_DB_PGSQL', 'PostgreSQL Datenbank');
define('_DB_MSSQL', 'Microsoft SQL Server Datenbank');
define('_DB_BACKUP', 'Datenbank sichern');
define('_DB_OPTIMIZATION', 'Datenbank optimieren');
define('_DB_RESTORE', 'Datenbank wiederherstellen');
define('_DB_START_BACKUP', 'Jetzt sichern');
define('_DB_START_OPTIMIZATION', 'Jetzt optimieren');
define('_DB_START_RESTORE', 'Jetzt wiederherstellen');
define('_DB_CONFIG', 'Datenbank Konfiguration');
define('_DB_BACKUP_RESTORE', 'Datenbank Sicherung &amp; Wiederherstellung');
define('_DB_BACKUP_OPTIMIZATION', 'Database Optimierung');
...
define('_STATS_PAGE', 'Seite');
define('_STATS_COUNT', 'Anzahl');
define('_STATS_SUM_CLICKS', 'Gesamtanzahl Hits');
define('_STATS_SUM_UNIQUE', 'Gesamtanzahl echte Hits');
define('_STATS_SUM_IP', 'Gesamtanzahl verschiedener IP Adressen');
define('_STATS_BROWSER_OS', 'Browser, Betriebssysteme');
...
// COUNTRY LIST
define('_COUNTRY_AFGHANISTAN', 'Afghanistan');
define('_COUNTRY_ALBANIA', 'Albanien');
define('_COUNTRY_ALGERIA', 'Algerien');
define('_COUNTRY_AMERICANSAMOA', 'Amerikanische Samoa Inseln');
define('_COUNTRY_ANDORRA', 'Andorra');
define('_COUNTRY_ANGOLA', 'Angola');
define('_COUNTRY_ANQUILLA', 'Anguilla');
define('_COUNTRY_ANTARCTICA', 'Antarktis');
define('_COUNTRY_ANTIQUAANDBARBUDA', 'Antigua und Barbuda');
define('_COUNTRY_ARGENTINA', 'Argentinien');
...
define('_COUNTRY_BANGLADESH', 'Bangladesch');
define('_COUNTRY_BARBADOS', 'Barbados');
define('_COUNTRY_BELGIUM', 'Belgien');
define('_COUNTRY_BELIZE', 'Belize');
define('_COUNTRY_BENIN', 'Benin');
define('_COUNTRY_BERMUDA', 'Bermuda');
define('_COUNTRY_BHUTAN', 'Bhutan');
define('_COUNTRY_BOLIVIA', 'Bolivien');
define('_COUNTRY_BOSNIAANDHERZEGOVINA', 'Bosnien und Herzegowina');
define('_COUNTRY_BOTSWANA', 'Botswana');
define('_COUNTRY_BOUVETISLAND', 'Bouvet Insel');
define('_COUNTRY_BRAZIL', 'Brasilien');
define('_COUNTRY_BRITININDIAOCEAN', 'Brit. Territorium im Indischen Ozean');
define('_COUNTRY_VIRGINISLANDS', 'Virgin Islands');
define('_COUNTRY_BULGARIA', 'Bulgarien');
define('_COUNTRY_BURKINAFASO', 'Burkina Faso');
define('_COUNTRY_BURUNDI', 'Burundi');
define('_COUNTRY_BRUNEI', 'Brunei');
define('_COUNTRY_CAYMANISLAND', 'Cayman Inseln');
define('_COUNTRY_CHILE', 'Chile');
define('_COUNTRY_CHINA', 'China');
define('_COUNTRY_COOKISLANDS', 'Cook Inseln');
define('_COUNTRY_COSTARICA', 'Costa Rica');
define('_COUNTRY_GERMANY', 'Deutschland');
...
define('_COUNTRY_FALKLANDISLANDS', 'Falkland Inseln (Malvinen)');
...
define('_COUNTRY_GUINEA', 'Guinea');
define('_COUNTRY_GUINEABISSAU', 'Guinea - Bissau');
define('_COUNTRY_GUYANA', 'Guyana');
define('_COUNTRY_HAITI', 'Haiti');
define('_COUNTRY_HEARDMCDONALDISLANDS', 'Heard und McDonald - Inseln');
define('_COUNTRY_HONDURAS', 'Honduras');
define('_COUNTRY_HONGKONG', 'Hong Kong');
define('_COUNTRY_INDIA', 'Indien');
define('_COUNTRY_INDONESIA', 'Indonesien');
define('_COUNTRY_IRAQ', 'Irak');
define('_COUNTRY_IRAN', 'Iran');
define('_COUNTRY_IRELAND', 'Irland');
define('_COUNTRY_ICELAND', 'Island');
define('_COUNTRY_ISRAEL', 'Israel');
define('_COUNTRY_ITALY', 'Italien');
define('_COUNTRY_JAMAICA', 'Jamaika');
...
define('_COUNTRY_MARTINIQUE', 'Martinique');
...
define('_COUNTRY_THAILAND', 'Thailand');
define('_COUNTRY_TOGO', 'Togo');
define('_COUNTRY_TOKELAU', 'Tokelau');
define('_COUNTRY_TONGA', 'Tonga');
define('_COUNTRY_TRINIDATANDTOBAGO', 'Trinidad und Tobago');
define('_COUNTRY_CHAD', 'Tschad');
define('_COUNTRY_CZECHREPUBLIC', 'Tschechien');
define('_COUNTRY_TUNISIA', 'Tunesien');
define('_COUNTRY_TURKSANDCAICOSISLANDS', 'Turk und Caicos Inseln');
define('_COUNTRY_TUVALU', 'Tuvalu');
define('_COUNTRY_TURKEY', 'T&#252;rkei');
define('_COUNTRY_USMINOROUTLYINGISLANDS', 'U.S. Minor Outlying Inseln');
define('_COUNTRY_UGANDA', 'Uganda');
define('_COUNTRY_UKRAINA', 'Ukraine');
define('_COUNTRY_HUNGARY', 'Ungarn');
define('_COUNTRY_URUGUAY', 'Uruguay');
define('_COUNTRY_UZBEKISTAN', 'Usbekistan');
define('_COUNTRY_USA', 'Vereinigte Staaten von Amerika');
define('_COUNTRY_VANUATA', 'Vanuatu');
define('_COUNTRY_VATICANCITY', 'Vatikanstaat');
define('_COUNTRY_VENEZUELA', 'Venezuela');
define('_COUNTRY_UAE', 'Vereinigte Arabische Emirate');
define('_COUNTRY_VIETNAM', 'Vietnam');
define('_COUNTRY_VALAISANDFUTUNAISLANDS', 'Wallis und Futuna Inseln');
define('_COUNTRY_CHRISTMASISLANDS', 'Weihnachtsinsel');
