...
if(!defined('_TCMS_ADMIN_BACK'))               define('_TCMS_ADMIN_BACK', 'Back');
...
if(!defined('_TCMS_ADMIN_NEW_USER'))           define('_TCMS_ADMIN_NEW_USER', 'Add new User...');
if(!defined('_TCMS_ADMIN_NEW_FTPALBUM'))       define('_TCMS_ADMIN_NEW_FTPALBUM', 'Add new Album from FTP Folder...');
...
if(!defined('_TCMS_ADMIN_DEV'))                define('_TCMS_ADMIN_DEV', 'developed by');
...
if(!defined('_TCMS_PRINT_NOW'))                define('_TCMS_PRINT_NOW', 'Print');
if(!defined('_TCMS_COLOR_CHOOSER'))            define('_TCMS_COLOR_CHOOSER', 'Colorchooser');
if(!defined('_TCMS_MONTH_JANUARY'))            define('_TCMS_MONTH_JANUARY', 'January');
if(!defined('_TCMS_MONTH_FEBUARY'))            define('_TCMS_MONTH_FEBUARY', 'Febuary');
if(!defined('_TCMS_MONTH_MARCH'))              define('_TCMS_MONTH_MARCH', 'March');
if(!defined('_TCMS_MONTH_APRIL'))              define('_TCMS_MONTH_APRIL', 'April');
if(!defined('_TCMS_MONTH_MAY'))                define('_TCMS_MONTH_MAY', 'May');
if(!defined('_TCMS_MONTH_JUNE'))               define('_TCMS_MONTH_JUNE', 'June');
if(!defined('_TCMS_MONTH_JULY'))               define('_TCMS_MONTH_JULY', 'July');
...
if(!defined('_TCMS_MONTH_OCTOBER'))            define('_TCMS_MONTH_OCTOBER', 'October');
if(!defined('_TCMS_MONTH_NOVEMBER'))           define('_TCMS_MONTH_NOVEMBER', 'November');
if(!defined('_TCMS_MONTH_DECEMBER'))           define('_TCMS_MONTH_DECEMBER', 'December');
if(!defined('_TCMS_DAY_MONDAY'))               define('_TCMS_DAY_MONDAY', 'Monday');
if(!defined('_TCMS_DAY_TUESDAY'))              define('_TCMS_DAY_TUESDAY', 'Tuesday');
if(!defined('_TCMS_DAY_WEDNESDAY'))            define('_TCMS_DAY_WEDNESDAY', 'Wednesday');
if(!defined('_TCMS_DAY_THURSDAY'))             define('_TCMS_DAY_THURSDAY', 'Thursday');
if(!defined('_TCMS_DAY_FRIDAY'))               define('_TCMS_DAY_FRIDAY', 'Friday');
if(!defined('_TCMS_DAY_SATURDAY'))             define('_TCMS_DAY_SATURDAY', 'Saturday');
if(!defined('_TCMS_DAY_SUNDAY'))               define('_TCMS_DAY_SUNDAY', 'Sunday');
if(!defined('_TCMS_DAY_MONDAY_XS'))            define('_TCMS_DAY_MONDAY_XS', 'Mon');
if(!defined('_TCMS_DAY_TUESDAY_XS'))           define('_TCMS_DAY_TUESDAY_XS', 'Tue');
if(!defined('_TCMS_DAY_WEDNESDAY_XS'))         define('_TCMS_DAY_WEDNESDAY_XS', 'Wed');
if(!defined('_TCMS_DAY_THURSDAY_XS'))          define('_TCMS_DAY_THURSDAY_XS', 'Thu');
...
if(!defined('_TCMS_BORDER'))                   define('_TCMS_BORDER', 'Border');
if(!defined('_TCMS_WEEKDAY'))                  define('_TCMS_WEEKDAY', 'Weekday');
...
if(!defined('_TCMS_TOPMENU_MANAGE'))           define('_TCMS_TOPMENU_MANAGE', 'Manage');
if(!defined('_TCMS_TOPMENU_NAVIGATION'))       define('_TCMS_TOPMENU_NAVIGATION', 'Navigation');
if(!defined('_TCMS_TOPMENU_SETTINGS'))         define('_TCMS_TOPMENU_SETTINGS', 'Settings');
if(!defined('_TCMS_TOPMENU_CONTENT'))          define('_TCMS_TOPMENU_CONTENT', 'Content');
if(!defined('_TCMS_TOPMENU_SIDEBAR'))          define('_TCMS_TOPMENU_SIDEBAR', 'Sidebar');
if(!defined('_TCMS_TOPMENU_EXTENSIONS'))       define('_TCMS_TOPMENU_EXTENSIONS', 'Extensions');
...
if(!defined('_TCMS_MENU_LOGOUT'))              define('_TCMS_MENU_LOGOUT', 'Logout');
if(!defined('_TCMS_MENU_PAGE'))                define('_TCMS_MENU_PAGE', 'Desktop');
if(!defined('_TCMS_MENU_FILE'))                define('_TCMS_MENU_FILE', 'Filemanager');
if(!defined('_TCMS_MENU_MEDIA'))               define('_TCMS_MENU_MEDIA', 'Media Manager');
if(!defined('_TCMS_MENU_NEWS_CATEGORIES'))     define('_TCMS_MENU_NEWS_CATEGORIES', 'News Categories');
if(!defined('_TCMS_MENU_COMMENTS'))            define('_TCMS_MENU_COMMENTS', 'Comments');
if(!defined('_TCMS_MENU_GUESTBOOK'))           define('_TCMS_MENU_GUESTBOOK', 'Guestbook Entrys');
if(!defined('_TCMS_MENU_NOTE'))                define('_TCMS_MENU_NOTE', 'Notebook');
if(!defined('_TCMS_MENU_SIDEMENU'))            define('_TCMS_MENU_SIDEMENU', 'Sidemenu');
if(!defined('_TCMS_MENU_TOPMENU'))             define('_TCMS_MENU_TOPMENU', 'Topmenu');
if(!defined('_TCMS_MENU_MENUTITLE'))           define('_TCMS_MENU_MENUTITLE', 'Menutitle');
if(!defined('_TCMS_MENU_CONTENT'))             define('_TCMS_MENU_CONTENT', 'Documents');
if(!defined('_TCMS_MENU_NEWS'))                define('_TCMS_MENU_NEWS', 'News');
if(!defined('_TCMS_MENU_DOWN'))                define('_TCMS_MENU_DOWN', 'Downloads');
if(!defined('_TCMS_MENU_PRODUCTS'))            define('_TCMS_MENU_PRODUCTS', 'Products');
if(!defined('_TCMS_MENU_FAQ'))                 define('_TCMS_MENU_FAQ', 'Knowledgebase');
if(!defined('_TCMS_MENU_SIDEEXT'))             define('_TCMS_MENU_SIDEEXT', 'Extensions');
if(!defined('_TCMS_MENU_SIDE'))                define('_TCMS_MENU_SIDE', 'Sidebar');
if(!defined('_TCMS_MENU_NEWSLETTER'))          define('_TCMS_MENU_NEWSLETTER', 'Newsletter');
if(!defined('_TCMS_MENU_POLL'))                define('_TCMS_MENU_POLL', 'Poll');
if(!defined('_TCMS_MENU_EXT'))                 define('_TCMS_MENU_EXT', 'Extensions');
if(!defined('_TCMS_MENU_FRONT'))               define('_TCMS_MENU_FRONT', 'Frontpage');
if(!defined('_TCMS_MENU_GALLERY'))             define('_TCMS_MENU_GALLERY', 'Imagegallery');
if(!defined('_TCMS_MENU_LINK'))                define('_TCMS_MENU_LINK', 'Links');
if(!defined('_TCMS_MENU_IMP'))                 define('_TCMS_MENU_IMP', 'Publishing form');
...
if(!defined('_TCMS_MENU_GLOBAL'))              define('_TCMS_MENU_GLOBAL', 'Global Configuration');
if(!defined('_TCMS_MENU_DB'))                  define('_TCMS_MENU_DB', 'Database Configuration');
if(!defined('_TCMS_MENU_STATS'))               define('_TCMS_MENU_STATS', 'Statistics');
if(!defined('_TCMS_MENU_THEME'))               define('_TCMS_MENU_THEME', 'Template Manager');
if(!defined('_TCMS_MENU_THEME_UPLOAD'))        define('_TCMS_MENU_THEME_UPLOAD', 'Template install&amp;edit');
if(!defined('_TCMS_MENU_THEME_PREVIEW'))       define('_TCMS_MENU_THEME_PREVIEW', 'Preview');
if(!defined('_TCMS_MENU_COPY'))                define('_TCMS_MENU_COPY', 'License');
if(!defined('_TCMS_MENU_CREDITS'))             define('_TCMS_MENU_CREDITS', 'Credits &amp; System');
if(!defined('_TCMS_MENU_DOCU'))                define('_TCMS_MENU_DOCU', 'Documentation');
if(!defined('_TCMS_MENU_HELP'))                define('_TCMS_MENU_HELP', 'Help');
if(!defined('_TCMS_MENU_SUPPORT'))             define('_TCMS_MENU_SUPPORT', 'Support');
if(!defined('_TCMS_MENU_ABOUT_MODULE'))        define('_TCMS_MENU_ABOUT_MODULE', 'About Module');
...
if(!defined('_MOD_PAGE'))                      define('_MOD_PAGE', 'Desktop');
if(!defined('_MOD_EXPLORE'))                   define('_MOD_EXPLORE', 'Filemanager - Explore your files');
if(!defined('_MOD_MEDIA'))                     define('_MOD_MEDIA', 'Media Manager - Administer your mediafiles');
if(!defined('_MOD_NEWS_CATEGORIES'))           define('_MOD_NEWS_CATEGORIES', 'Administer News Categories');
if(!defined('_MOD_COMMENTS'))                  define('_MOD_COMMENTS', 'Administer Comments');
if(!defined('_MOD_GUESTBOOK'))                 define('_MOD_GUESTBOOK', 'Administer Guestbook Entrys');
if(!defined('_MOD_NOTE'))                      define('_MOD_NOTE', 'Notebook - Remember your idea\'s');
if(!defined('_MOD_SIDEMENU'))                  define('_MOD_NEWPAGE', 'Create a new page');
if(!defined('_MOD_SIDEMENU'))                  define('_MOD_SIDEMENU', 'Sidemenu Manager');
if(!defined('_MOD_TOPMENU'))                   define('_MOD_TOPMENU', 'Topmenu Manager');
if(!defined('_MOD_USERMENU'))                  define('_MOD_USERMENU', 'Usermenu Manager');
if(!defined('_MOD_MENUTITLE'))                 define('_MOD_MENUTITLE', 'Menutitle Manager');
if(!defined('_MOD_CONTENT'))                   define('_MOD_CONTENT', 'Documents Manager');
if(!defined('_MOD_NEWS'))                      define('_MOD_NEWS', 'News Manager');
if(!defined('_MOD_DOWN'))                      define('_MOD_DOWN', 'Download Manager');
if(!defined('_MOD_PRODUCTS'))                  define('_MOD_PRODUCTS', 'Products Manager');
...
// TABLES
if(!defined('_TABLE_TITLE'))                   define('_TABLE_TITLE', 'Title');
if(!defined('_TABLE_SUBTITLE'))                define('_TABLE_SUBTITLE', 'Subtitle');
if(!defined('_TABLE_PUBLISH'))                 define('_TABLE_PUBLISH', 'Publishing Info');
if(!defined('_TABLE_TEXT'))                    define('_TABLE_TEXT', 'Main Text');
...
if(!defined('_TABLE_FILE'))                    define('_TABLE_FILE', 'File');
if(!defined('_TABLE_FILE_EXISTS'))             define('_TABLE_FILE_EXISTS', 'If file exists, please enter the complete filename. Please think about that before uploading: Create a folder with the name of the file, but without extensions like .zip and spaces must be underlines (_). This folder will be used.');
if(!defined('_TABLE_FILE_OTHERURL'))           define('_TABLE_FILE_OTHERURL', 'If the file on a other server, enter here the complete adress and the name of the file (a folder will be create from this name).');
if(!defined('_TABLE_FILE_EXISTS_NAME'))        define('_TABLE_FILE_EXISTS_NAME', 'File exists');
if(!defined('_TABLE_FILE_OTHERURL_NAME'))      define('_TABLE_FILE_OTHERURL_NAME', 'File on other Server');
if(!defined('_TABLE_DATE'))                    define('_TABLE_DATE', 'Date');
if(!defined('_TABLE_TIME'))                    define('_TABLE_TIME', 'Time');
if(!defined('_TABLE_EMAIL'))                   define('_TABLE_EMAIL', 'eMail');
if(!defined('_TABLE_OPTION'))                  define('_TABLE_OPTION', 'Option');
if(!defined('_TABLE_INFO'))                    define('_TABLE_INFO', 'Information');
if(!defined('_TABLE_ORDER_HELP'))              define('_TABLE_ORDER_HELP', '(Identify Number)');
if(!defined('_TABLE_ALBUM'))                   define('_TABLE_ALBUM', 'Album');
if(!defined('_TABLE_DIR'))                     define('_TABLE_DIR', 'Directory');
if(!defined('_TABLE_BACKENDFILE'))             define('_TABLE_BACKENDFILE', 'Backend file');
if(!defined('_TABLE_FRONTENDFILE'))            define('_TABLE_FRONTENDFILE', 'Frontend file');
if(!defined('_TABLE_SIDEBARFILE'))             define('_TABLE_SIDEBARFILE', 'Sidebar file');
if(!defined('_TABLE_SETTINGSFILE'))            define('_TABLE_SETTINGSFILE', 'Settings file');
if(!defined('_TABLE_IMAGE'))                   define('_TABLE_IMAGE', 'Image');
if(!defined('_TABLE_IMAGES'))                  define('_TABLE_IMAGES', 'Images');
if(!defined('_TABLE_USE'))                     define('_TABLE_USE', 'Use');
if(!defined('_TABLE_DELETE'))                  define('_TABLE_DELETE', 'Delete');
if(!defined('_TABLE_DESCRIPTION'))             define('_TABLE_DESCRIPTION', 'Description');
if(!defined('_TABLE_NEW'))                     define('_TABLE_NEW', 'New Entry');
if(!defined('_TABLE_EDIT'))                    define('_TABLE_EDIT', 'Edit Entry');
if(!defined('_TABLE_DETAILS'))                 define('_TABLE_DETAILS', 'Entry Details');
if(!defined('_TABLE_GENERAL'))                 define('_TABLE_GENERAL', 'General Information');
if(!defined('_TABLE_FURTHER'))                 define('_TABLE_FURTHER', 'Further data');
if(!defined('_TABLE_SETTINGS'))                define('_TABLE_SETTINGS', 'Settings');
if(!defined('_TABLE_CONTACT'))                 define('_TABLE_CONTACT', 'Contact information');
if(!defined('_TABLE_PRODUCTNO'))               define('_TABLE_PRODUCTNO', 'Article Number');
if(!defined('_TABLE_FACTORY'))                 define('_TABLE_FACTORY', 'Manufacturer');
if(!defined('_TABLE_URL'))                     define('_TABLE_URL', 'Website');
if(!defined('_TABLE_STOCK'))                   define('_TABLE_STOCK', 'In Stock');
...
if(!defined('_TABLE_QUANTITY'))                define('_TABLE_QUANTITY', 'Quantity');
if(!defined('_TABLE_WEIGHT'))                  define('_TABLE_WEIGHT', 'Weight');
if(!defined('_TABLE_SAVEBUTTON'))              define('_TABLE_SAVEBUTTON', 'Save');
if(!defined('_TABLE_EDITBUTTON'))              define('_TABLE_EDITBUTTON', 'Edit');
if(!defined('_TABLE_DELBUTTON'))               define('_TABLE_DELBUTTON', 'Delete');
if(!defined('_TABLE_SETTINGSBUTTON'))          define('_TABLE_SETTINGSBUTTON', 'Settings');
if(!defined('_TABLE_ADMINBUTTON'))             define('_TABLE_ADMINBUTTON', 'Administer');
if(!defined('_TABLE_ACCEPTBUTTON'))            define('_TABLE_ACCEPTBUTTON', 'Accept');
if(!defined('_TABLE_THUMBNAIL'))               define('_TABLE_THUMBNAIL', 'Thumbnail');
if(!defined('_TABLE_GOUPBUTTON'))              define('_TABLE_GOUPBUTTON', 'Go up');
if(!defined('_TABLE_ACCESS'))                  define('_TABLE_ACCESS', 'Access Level');
if(!defined('_TABLE_MACCESS'))                 define('_TABLE_MACCESS', 'Access');
if(!defined('_TABLE_LINKTO'))                  define('_TABLE_LINKTO', 'Link to');
if(!defined('_TABLE_COMMENTS'))                define('_TABLE_COMMENTS', 'Comments');
if(!defined('_TABLE_LINK'))                    define('_TABLE_LINK', 'CID');
if(!defined('_TABLE_PUBLIC'))                  define('_TABLE_PUBLIC', 'Public (For all guests)');
if(!defined('_TABLE_PROTECTED'))               define('_TABLE_PROTECTED', 'Protected (For registered users)');
if(!defined('_TABLE_PRIVATE'))                 define('_TABLE_PRIVATE', 'Private (Not for users and guests)');
if(!defined('_TABLE_WHICHMENU'))               define('_TABLE_WHICHMENU', 'Entry in which menu?');
if(!defined('_TABLE_SIDEMENU'))                define('_TABLE_SIDEMENU', 'Sidemenu');
if(!defined('_TABLE_TOPMENU'))                 define('_TABLE_TOPMENU', 'Topmenu');
if(!defined('_TABLE_USERMENU'))                define('_TABLE_USERMENU', 'Usermenu');
if(!defined('_TABLE_CHARSET'))                 define('_TABLE_CHARSET', 'Charset');
if(!defined('_TABLE_ALIAS'))                   define('_TABLE_ALIAS', 'Aliases');
if(!defined('_TABLE_LEFT'))                    define('_TABLE_LEFT', 'Left');
if(!defined('_TABLE_RIGHT'))                   define('_TABLE_RIGHT', 'Right');
if(!defined('_TABLE_CENTER'))                  define('_TABLE_CENTER', 'Center');
if(!defined('_TABLE_TYPE'))                    define('_TABLE_TYPE', 'Type');
if(!defined('_TABLE_MENUTITLE'))               define('_TABLE_MENUTITLE', 'Menutitle');
if(!defined('_TABLE_MENULINK'))                define('_TABLE_MENULINK', 'Link');
if(!defined('_TABLE_MENUWEB'))                 define('_TABLE_MENUWEB', 'Weblink');
if(!defined('_TABLE_REORDER'))                 define('_TABLE_REORDER', 'Reorder');
if(!defined('_TABLE_DEFAULT_NEWS_CATEGORY'))   define('_TABLE_DEFAULT_NEWS_CATEGORY', 'Default News Category');
if(!defined('_TABLE_MAIN_CS'))                 define('_TABLE_MAIN_CS', 'Component for Mainpage');
if(!defined('_TABLE_SIDE_CS'))                 define('_TABLE_SIDE_CS', 'Component for Sidebar');
if(!defined('_TABLE_START'))                   define('_TABLE_START', 'Start');
if(!defined('_TABLE_PREVIOUS'))                define('_TABLE_PREVIOUS', 'Previous');
if(!defined('_TABLE_NEXT'))                    define('_TABLE_NEXT', 'Next');
if(!defined('_TABLE_END'))                     define('_TABLE_END', 'Ende');
if(!defined('_TABLE_DISPLAY'))                 define('_TABLE_DISPLAY', 'Display');
if(!defined('_TABLE_A_PAGE'))                  define('_TABLE_A_PAGE', 'a page');
if(!defined('_TABLE_OF'))                      define('_TABLE_OF', 'of');
if(!defined('_TABLE_ENABLED_THIS'))            define('_TABLE_ENABLED_THIS', 'Enable');
if(!defined('_TABLE_DISABLED_THIS'))           define('_TABLE_DISABLED_THIS', 'Disable');
if(!defined('_TABLE_IP'))                      define('_TABLE_IP', 'IP');
if(!defined('_TABLE_DOMAIN'))                  define('_TABLE_DOMAIN', 'Domain');
if(!defined('_TABLE_SIDEBAR'))                 define('_TABLE_SIDEBAR', 'Sidebar');
if(!defined('_TABLE_MAINCONTENT'))             define('_TABLE_MAINCONTENT', 'Mainpage');
if(!defined('_TABLE_BOTH'))                    define('_TABLE_BOTH', 'Both');
if(!defined('_TABLE_FILTER'))                  define('_TABLE_FILTER', 'Filter and Settings');
if(!defined('_TABLE_SORT_SIDE'))               define('_TABLE_SORT_SIDE', 'Sidebar Position');
if(!defined('_TABLE_LOCATION'))                define('_TABLE_LOCATION', 'Location');
if(!defined('_TABLE_DATES'))                   define('_TABLE_DATES', 'Dates');
if(!defined('_TABLE_HELPBROWSER'))             define('_TABLE_HELPBROWSER', 'toendaCSM Help');
if(!defined('_TABLE_LINKBROWSER'))             define('_TABLE_LINKBROWSER', 'Linkbrowser');
if(!defined('_TABLE_LINKBROWSER_TEXT'))        define('_TABLE_LINKBROWSER_TEXT', 'Click on the button to use the link in your document. You can enter a title in the textfield to set the name of the link.');
if(!defined('_TABLE_LINKBROWSER_TEXT_TINYMCE'))define('_TABLE_LINKBROWSER_TEXT_TINYMCE', '<strong>tinyMCE:</strong> You must have selected a text to change it into a link.');
if(!defined('_TABLE_IMAGEBROWSER'))            define('_TABLE_IMAGEBROWSER', 'Mediabrowser');
if(!defined('_TABLE_IMAGEBROWSER_TEXT'))       define('_TABLE_IMAGEBROWSER_TEXT', 'Click on the button to use the mediafiles in your document.');
...
if(!defined('_MSG_GOTOINSTALL'))               define('_MSG_GOTOINSTALL', 'GO TO INSTALLATION');
if(!defined('_MSG_RM_INSTALLDIR'))             define('_MSG_RM_INSTALLDIR', 'Please remove installation dir!');
if(!defined('_MSG_PAGE_LOAD_1'))               define('_MSG_PAGE_LOAD_1', 'Page generated in');
if(!defined('_MSG_PAGE_LOAD_2'))               define('_MSG_PAGE_LOAD_2', 'seconds');
if(!defined('_MSG_NOIMAGE'))                   define('_MSG_NOIMAGE', 'No image selected.');
if(!defined('_MSG_IMAGE'))                     define('_MSG_IMAGE', 'Image succesfull uploadet to');
if(!defined('_MSG_NONAME'))                    define('_MSG_NONAME', 'Please enter your name');
if(!defined('_MSG_NOCAPTCHA'))                 define('_MSG_NOCAPTCHA', 'Please enter the code in the image');
if(!defined('_MSG_CAPTCHA_NOT_VALID'))         define('_MSG_CAPTCHA_NOT_VALID', 'The entered code and the code in the image are not the same');
if(!defined('_MSG_FALSEPASSWORD'))             define('_MSG_FALSEPASSWORD', 'False Password!');
if(!defined('_MSG_PASSWORDNOTVALID'))          define('_MSG_PASSWORDNOTVALID', 'Password not valid!');
if(!defined('_MSG_NOPASSWORD'))                define('_MSG_NOPASSWORD', 'Passwords not valid!');
if(!defined('_MSG_NOEMAIL'))                   define('_MSG_NOEMAIL', 'No eMail-adress given');
if(!defined('_MSG_EMAILVALID'))                define('_MSG_EMAILVALID', 'eMail-adress not valid');
...
if(!defined('_MSG_NOSUBJECT'))                 define('_MSG_NOSUBJECT', 'Please enter subject');
if(!defined('_MSG_NOMSG'))                     define('_MSG_NOMSG', 'Please enter message');
if(!defined('_MSG_NEWSLETTER'))                define('_MSG_NEWSLETTER', 'You have successfully subscribe to our newsletter.');
if(!defined('_MSG_POLL'))                      define('_MSG_POLL', 'Thank you for your vote in this poll.');
...
if(!defined('_MSG_DISABLED_MODUL'))            define('_MSG_DISABLED_MODUL', 'The choosen module is disabled. You cannot use it!!');
if(!defined('_MSG_CHANGE_DATABASE_ENGINE'))    define('_MSG_CHANGE_DATABASE_ENGINE', 'Do you really want to change the database?\nYou should be loged out and cannot use your data in another database.\nSorry, but the XML - SQL Import feature is planned...');
if(!defined('_MSG_IF_DOWNLOAD_DOES_NOT_START'))define('_MSG_IF_DOWNLOAD_DOES_NOT_START', 'If your download does not start, click the follow link');
if(!defined('_MSG_BACKUP_SUCCESSFULL'))        define('_MSG_BACKUP_SUCCESSFULL', 'Database backup sucessfull.\nAffected tables:');
...
if(!defined('_LOGIN_USERNAME'))                define('_LOGIN_USERNAME', 'Username');
if(!defined('_LOGIN_USERNAME_JS'))             define('_LOGIN_USERNAME_JS', 'Please enter your username!');
if(!defined('_LOGIN_PASSWORD'))                define('_LOGIN_PASSWORD', 'Password');
if(!defined('_LOGIN_PASSWORD_JS'))             define('_LOGIN_PASSWORD_JS', 'Please enter your password!');
if(!defined('_LOGIN_FALSE'))                   define('_LOGIN_FALSE', 'False: Username, Password or Userrights (Group)');
if(!defined('_LOGIN_FALSE_LPW'))               define('_LOGIN_FALSE_LPW', 'False: Username or eMail');
if(!defined('_LOGIN_SUBMIT'))                  define('_LOGIN_SUBMIT', 'Login');
if(!defined('_LOGIN_LOGOUT'))                  define('_LOGIN_LOGOUT', 'Logout');
if(!defined('_LOGIN_PROFILE'))                 define('_LOGIN_PROFILE', 'Profile');
if(!defined('_LOGIN_LIST'))                    define('_LOGIN_LIST', 'Memberlist');
if(!defined('_LOGIN_LIST_TEXT'))               define('_LOGIN_LIST_TEXT', 'This is the list of all members. You can click on the username to view his profile.');
if(!defined('_LOGIN_ADMIN'))                   define('_LOGIN_ADMIN', 'Administration');
if(!defined('_LOGIN_FORGOTPW'))                define('_LOGIN_FORGOTPW', ' Forgotten your password?');
if(!defined('_LOGIN_WELCOME'))                 define('_LOGIN_WELCOME', 'Welcome');
if(!defined('_LOGIN_SUBMIT_NEWS'))             define('_LOGIN_SUBMIT_NEWS', 'Submit News');
if(!defined('_LOGIN_SUBMIT_IMAGES'))           define('_LOGIN_SUBMIT_IMAGES', 'Submit Images');
if(!defined('_LOGIN_CREATE_ALBUM'))            define('_LOGIN_CREATE_ALBUM', 'Create Album');
if(!defined('_LOGIN_CREATE_CATEGORY'))         define('_LOGIN_CREATE_CATEGORY', 'Create Category');
if(!defined('_LOGIN_SUBMIT_MEDIA'))            define('_LOGIN_SUBMIT_MEDIA', 'Submit Media');


// REGISTRATION
if(!defined('_REG_TITLE'))                     define('_REG_TITLE', 'Registration');
if(!defined('_REG_LPW'))                       define('_REG_LPW', 'Lost your Password?');
if(!defined('_REG_LPWTEXT'))                   define('_REG_LPWTEXT', 'Please enter your Username and e-mail address then click on the Send Password button. You will receive a new password shortly. Use this new password to access the site.');
if(!defined('_REG_TEXT_1'))                    define('_REG_TEXT_1', 'Fields mark with an full bullet are required.');
if(!defined('_REG_TEXT_2'))                    define('_REG_TEXT_2', 'With an empty bullet are not.');
if(!defined('_REG_SUBMIT_LPW'))                define('_REG_SUBMIT_LPW', 'Send Password');
if(!defined('_REG_SUBMIT_SR'))                 define('_REG_SUBMIT_SR', 'Send Registration');
if(!defined('_REG_PWNOTAGREE'))                define('_REG_PWNOTAGREE', 'Passwords do not agree!');
if(!defined('_REG_NAME_NG'))                   define('_REG_NAME_NG', 'Name is not given!');
if(!defined('_REG_USERNAME_NG'))               define('_REG_USERNAME_NG', 'Username is not given!');
if(!defined('_REG_PASSWORD_NG'))               define('_REG_PASSWORD_NG', 'Password is not given!');
if(!defined('_REG_EMAIL_NG'))                  define('_REG_EMAIL_NG', 'eMail is not given!');
if(!defined('_REG_LPW_SUCCESS'))               define('_REG_LPW_SUCCESS', 'Your new Password');
if(!defined('_REG_SUCCESS'))                   define('_REG_SUCCESS', 'Your registration was successfully');
if(!defined('_REG_NO_SUCCESS'))                define('_REG_NO_SUCCESS', 'Your registration was not successfully');
if(!defined('_REG_SUCCESS_TEXT'))              define('_REG_SUCCESS_TEXT', 'Your registration was successfull Click on the link and you will have access to the website with the login.');
if(!defined('_REG_AUTO_MSG'))                  define('_REG_AUTO_MSG', 'This is a automatically message from');
if(!defined('_REG_TEXT_LPW'))                  define('_REG_TEXT_LPW', 'A user want to get a new passwort for this user. This is your new password.');
if(!defined('_REG_VALIDATE'))                  define('_REG_VALIDATE', 'Congratulations, you are now registered. You can now logon to the website using your choosen username and password.');
if(!defined('_REG_NO_VALIDATE'))               define('_REG_NO_VALIDATE', 'Failed, your validation code is not valid.');
if(!defined('_REG_USERPROFILE'))               define('_REG_USERPROFILE', 'Tip: You can change some settings such as your password, username and other under your profile.');
if(!defined('_REG_EMAIL'))                     define('_REG_EMAIL', 'A new user has been registrated.');
if(!defined('_REG_SUCCESS_MAIL'))              define('_REG_SUCCESS_MAIL', 'A new user has been registrated over your webpage.');


// PROFILE
if(!defined('_PROFILE_TITLE'))                 define('_PROFILE_TITLE', 'Viewing User Profile');
if(!defined('_PROFILE_EDIT'))                  define('_PROFILE_EDIT', 'Edit User Profile');
...
// SIDEMENU
if(!defined('_SIDEMENU_TITLE'))                define('_SIDEMENU_TITLE', 'Sidemenu Links');
if(!defined('_SIDEMENU_TEXT'))                 define('_SIDEMENU_TEXT', 'Here can you create you mainmenu. The ID is the order of you menu, SUB ID is the order of you submenu, CID is the ID of the content or extension pages to link. You can edit each entry by clicking the entry self.');


// COMPONENTS SYSTEM
if(!defined('_CS_TITLE'))                      define('_CS_TITLE', 'Components System Objects');
if(!defined('_CS_TEXT'))                       define('_CS_TEXT', 'This is a list of all your installed components. You can change its settings.');


// TOPMENU
if(!defined('_TOPMENU_TITLE'))                 define('_TOPMENU_TITLE', 'Topmenu Links');
if(!defined('_TOPMENU_TEXT'))                  define('_TOPMENU_TEXT', 'Here can you create your topmenu. The ID is the order of you menu, CID is the ID of the content or extension pages to link.');


// MENUTITLE
if(!defined('_MENUTITLE_TITLE'))               define('_MENUTITLE_TITLE', 'Menutitle');
if(!defined('_MENUTITLE_TEXT'))                define('_MENUTITLE_TEXT', 'The Positions-Number set the place in the menu.');
...
// IMPRESSUM
if(!defined('_IMPRESSUM_CONFIG'))              define('_IMPRESSUM_CONFIG', 'Impressum Configuration');
if(!defined('_IMPRESSUM_ID'))                  define('_IMPRESSUM_ID', 'ID');
if(!defined('_IMPRESSUM_TITLE'))               define('_IMPRESSUM_TITLE', 'Impressum title');
if(!defined('_IMPRESSUM_SUBTITLE'))            define('_IMPRESSUM_SUBTITLE', 'Impressum subtitle');
if(!defined('_IMPRESSUM_CONTACT'))             define('_IMPRESSUM_CONTACT', 'Contactperson');
if(!defined('_IMPRESSUM_NO_CONTACT'))          define('_IMPRESSUM_NO_CONTACT', 'No contactperson');
if(!defined('_IMPRESSUM_SELECT'))              define('_IMPRESSUM_SELECT', 'Please choose');
if(!defined('_IMPRESSUM_TAX'))                 define('_IMPRESSUM_TAX', 'Tax number');
if(!defined('_IMPRESSUM_UST'))                 define('_IMPRESSUM_UST', 'Ust. Id.');
if(!defined('_IMPRESSUM_LEGAL'))               define('_IMPRESSUM_LEGAL', 'Legal');
if(!defined('_IMPRESSUM_PHONE'))               define('_IMPRESSUM_PHONE', 'Phone');
if(!defined('_IMPRESSUM_FAX'))                 define('_IMPRESSUM_FAX', 'Fax');
if(!defined('_IMPRESSUM_CONTACTPERSON'))       define('_IMPRESSUM_CONTACTPERSON', 'Contact person');
if(!defined('_IMPRESSUM_OFFICE'))              define('_IMPRESSUM_OFFICE', 'Office');
if(!defined('_IMPRESSUM_EMAIL'))               define('_IMPRESSUM_EMAIL', 'eMail');
if(!defined('_IMPRESSUM_COPY'))                define('_IMPRESSUM_COPY', 'All rights reserved.');
if(!defined('_IMPRESSUM_SITECOPY'))            define('_IMPRESSUM_SITECOPY', 'Site contents are copyright by');


// SIDEBAR
if(!defined('_SIDE_TEXT'))                     define('_SIDE_TEXT', 'The ID-Number is the number you need to link all pages.');
if(!defined('_SIDE_CONTACTS'))                 define('_SIDE_CONTACTS', 'Contacts');


// HELP
if(!defined('_HELP_SUPPORTED_CHARSETS'))       define('_HELP_SUPPORTED_CHARSETS', 'Supported charsets');
...
if(!defined('_GROUP_WRITER'))                  define('_GROUP_WRITER', 'Extended Editor');
if(!defined('_GROUP_EDITOR'))                  define('_GROUP_EDITOR', 'Simple Editor');
if(!defined('_GROUP_PRESENTER'))               define('_GROUP_PRESENTER', 'Presenter of the forum');
if(!defined('_GROUP_USER'))                    define('_GROUP_USER', 'User of the site');


// TCMS SCRIPT
if(!defined('_TCMSSCRIPT_BR'))                 define('_TCMSSCRIPT_BR', 'Linebreak');
if(!defined('_TCMSSCRIPT_MORE'))               define('_TCMSSCRIPT_MORE', 'Custom news stop for frontpage');
if(!defined('_TCMSSCRIPT_IMAGES'))             define('_TCMSSCRIPT_IMAGES', 'Browse images');


// GLOBAL ID
if(!defined('_NEWPAGE_TITLE'))                 define('_NEWPAGE_TITLE', 'Create a new page');
if(!defined('_NEWPAGE_TEXT'))                  define('_NEWPAGE_TEXT', 'With this dialog can you create a new page. Choose a title, the menu, if you want, a submenu and the access level.');


// EXPLORER
if(!defined('_EXPLORE_UP'))                    define('_EXPLORE_UP', 'Move entry up.');
if(!defined('_EXPLORE_DOWN'))                  define('_EXPLORE_DOWN', 'Move entry down.');


// NOTEBOOK
if(!defined('_NOTEBOOK_TITLE'))                define('_NOTEBOOK_TITLE', 'Personal Notebook');
...
if(!defined('_NOTEBOOK_DETAIL'))               define('_NOTEBOOK_DETAIL', 'Your Notebook');
if(!defined('_NOTEBOOK_MSG'))                  define('_NOTEBOOK_MSG', 'Your personal notebook wants you');


// EXTENSIONS
if(!defined('_EXT_NEWS'))                      define('_EXT_NEWS', 'News Manager');
if(!defined('_EXT_NEWS_NEWSAMOUNT'))           define('_EXT_NEWS_NEWSAMOUNT', 'Amount of news in newsmanager (not in archive)');
if(!defined('_EXT_NEWS_ID'))                   define('_EXT_NEWS_ID', 'ID');
if(!defined('_EXT_NEWS_TITLE'))                define('_EXT_NEWS_TITLE', 'News page title');
if(!defined('_EXT_NEWS_SUBTITLE'))             define('_EXT_NEWS_SUBTITLE', 'News page subtitle');
if(!defined('_EXT_NEWS_IMAGE'))                define('_EXT_NEWS_IMAGE', 'News page Image');
if(!defined('_EXT_NEWS_USE_COMMENTS'))         define('_EXT_NEWS_USE_COMMENTS', 'Use news comment');
if(!defined('_EXT_NEWS_USE_EMOTICONS'))        define('_EXT_NEWS_USE_EMOTICONS', 'Use emoticons in comments');
if(!defined('_EXT_NEWS_USE_GRAVATAR'))         define('_EXT_NEWS_USE_GRAVATAR', 'Use gravatar for users');
if(!defined('_EXT_NEWS_USE_AUTOR'))            define('_EXT_NEWS_USE_AUTOR', 'Show news author');
if(!defined('_EXT_NEWS_USE_AUTOR_LINK'))       define('_EXT_NEWS_USE_AUTOR_LINK', 'Show news author as link');
if(!defined('_EXT_NEWS_D_TIMESINCE'))          define('_EXT_NEWS_D_TIMESINCE', 'Timesince');
if(!defined('_EXT_NEWS_D_DATE'))               define('_EXT_NEWS_D_DATE', 'Normal Date');
if(!defined('_EXT_NEWS_D_TEXT'))               define('_EXT_NEWS_D_TEXT', 'Textual representation');
if(!defined('_EXT_NEWS_DISPLAY'))              define('_EXT_NEWS_DISPLAY', 'Representation of the date');
...
if(!defined('_EXT_NEWS_SELECT'))               define('_EXT_NEWS_SELECT', 'Please select');
if(!defined('_EXT_NEWS_DESELECT'))             define('_EXT_NEWS_DESELECT', 'No image');
if(!defined('_EXT_NEWS_USE_FEEDS'))            define('_EXT_NEWS_USE_FEEDS', 'Use Syndication (Feeds)');
if(!defined('_EXT_NEWS_USE_RSS091'))           define('_EXT_NEWS_USE_RSS091', 'Use RSS 0.91');
if(!defined('_EXT_NEWS_USE_RSS10'))            define('_EXT_NEWS_USE_RSS10', 'Use RSS 1.0');
if(!defined('_EXT_NEWS_USE_RSS20'))            define('_EXT_NEWS_USE_RSS20', 'Use RSS 2.0');
if(!defined('_EXT_NEWS_USE_ATOM03'))           define('_EXT_NEWS_USE_ATOM03', 'Use ATOM 0.3');
if(!defined('_EXT_NEWS_USE_OPML'))             define('_EXT_NEWS_USE_OPML', 'Use OPML');
if(!defined('_EXT_NEWS_SYN_AMOUNT'))           define('_EXT_NEWS_SYN_AMOUNT', 'Amount of news in feed');
if(!defined('_EXT_NEWS_USE_SYN_TITLE'))        define('_EXT_NEWS_USE_SYN_TITLE', 'Use Syndicationtitle in sidebar');
if(!defined('_EXT_NEWS_DEFAULT_FEED'))         define('_EXT_NEWS_DEFAULT_FEED', 'Default syndication feed');
if(!defined('_EXT_NEWS_USE_TRACKBACK'))        define('_EXT_NEWS_USE_TRACKBACK', 'Use Trackback');
if(!defined('_EXT_CFORM'))                     define('_EXT_CFORM', 'Contact Form');
if(!defined('_EXT_CFORM_SHOW_CONTACTS_IN_SIDEBAR'))define('_EXT_CFORM_SHOW_CONTACTS_IN_SIDEBAR', 'Show contacts in sidebar');
if(!defined('_EXT_CFORM_USE_ADRESSBOOK'))      define('_EXT_CFORM_USE_ADRESSBOOK', 'Use adressbook');
if(!defined('_EXT_CFORM_USE_CONTACTPERSON'))   define('_EXT_CFORM_USE_CONTACTPERSON', 'Show contactperson');
if(!defined('_EXT_CFORM_EMAIL'))               define('_EXT_CFORM_EMAIL', 'eMail');
if(!defined('_EXT_CFORM_ID'))                  define('_EXT_CFORM_ID', 'ID');
if(!defined('_EXT_CFORM_TITLE'))               define('_EXT_CFORM_TITLE', 'Contact form title');
if(!defined('_EXT_CFORM_SUBTITLE'))            define('_EXT_CFORM_SUBTITLE', 'Contact form subtitle');
if(!defined('_EXT_CFORM_SHOW_CONTACTEMAIL'))   define('_EXT_CFORM_SHOW_CONTACTEMAIL', 'Show contact emailadress');
if(!defined('_EXT_BOOK'))                      define('_EXT_BOOK', 'Guestbook');
if(!defined('_EXT_BOOK_ID'))                   define('_EXT_BOOK_ID', 'ID');
if(!defined('_EXT_BOOK_TITLE'))                define('_EXT_BOOK_TITLE', 'Guestbook title');
if(!defined('_EXT_BOOK_SUBTITLE'))             define('_EXT_BOOK_SUBTITLE', 'Guestbook subtitle');
if(!defined('_EXT_BOOK_ADMINPASS'))            define('_EXT_BOOK_ADMINPASS', 'Administration Password');
if(!defined('_EXT_BOOK_ADMINUSER'))            define('_EXT_BOOK_ADMINUSER', 'Administration Username');
if(!defined('_EXT_BOOK_ADMINCOLOR'))           define('_EXT_BOOK_ADMINCOLOR', 'Administration Textcolor');
if(!defined('_EXT_BOOK_ENTRYCOLOR'))           define('_EXT_BOOK_ENTRYCOLOR', 'Entrienumber Color');
if(!defined('_EXT_DOWNLOAD'))                  define('_EXT_DOWNLOAD', 'Download Manager configuration');
if(!defined('_EXT_DOWNLOAD_ID'))               define('_EXT_DOWNLOAD_ID', 'ID');
if(!defined('_EXT_DOWNLOAD_TITLE'))            define('_EXT_DOWNLOAD_TITLE', 'Download Manager title');
if(!defined('_EXT_DOWNLOAD_SUBTITLE'))         define('_EXT_DOWNLOAD_SUBTITLE', 'Download Manager subtitle');
...
// GALLERY
if(!defined('_GALLERY_CONFIG'))                define('_GALLERY_CONFIG', 'Imagegallery configuration');
if(!defined('_GALLERY_ID'))                    define('_GALLERY_ID', 'ID');
if(!defined('_GALLERY_COMMENTS'))              define('_GALLERY_COMMENTS', 'Use comments');
if(!defined('_GALLERY_FRONT_TITLE'))           define('_GALLERY_FRONT_TITLE', 'Gallery title');
if(!defined('_GALLERY_FRONT_SUBTITLE'))        define('_GALLERY_FRONT_SUBTITLE', 'Gallery subtitle');
if(!defined('_GALLERY_CREATE'))                define('_GALLERY_CREATE', 'Create new album');
if(!defined('_GALLERY_NEW'))                   define('_GALLERY_NEW', 'New album');
if(!defined('_GALLERY_DESCRIPTION'))           define('_GALLERY_DESCRIPTION', 'Description');
if(!defined('_GALLERY_TITLE'))                 define('_GALLERY_TITLE', 'Gallery');
if(!defined('_GALLERY_THISIS'))                define('_GALLERY_THISIS', 'This is the');
if(!defined('_GALLERY_THISIS2'))               define('_GALLERY_THISIS2', 'album');
if(!defined('_GALLERY_THISIS3'))               define('_GALLERY_THISIS3', 'Load up here your pictures, delete your pictures or edit the description. But only save on image description at one time.');
if(!defined('_GALLERY_IMGTITLE'))              define('_GALLERY_IMGTITLE', 'Title');
if(!defined('_GALLERY_IMGSIZE'))               define('_GALLERY_IMGSIZE', 'File Size');
if(!defined('_GALLERY_IMGRESOLUTION'))         define('_GALLERY_IMGRESOLUTION', 'Resolution');
if(!defined('_GALLERY_AMOUNT'))                define('_GALLERY_AMOUNT', 'Amount');
if(!defined('_GALLERY_IMG_DETAILS'))           define('_GALLERY_IMG_DETAILS', 'Use Image Details');
if(!defined('_GALLERY_FTP_UPLOAD'))            define('_GALLERY_FTP_UPLOAD', 'All available albums');
if(!defined('_GALLERY_FTP_UPLOAD_TEXT'))       define('_GALLERY_FTP_UPLOAD_TEXT', 'If have uploaded your imagealbum with your FTP client to "data/images/albums/" you can convert that album into an toendaCMS gallery album. Please choose one album to convert it in an toendaCMS Gallery album.');
if(!defined('_GALLERY_UPLOAD'))                define('_GALLERY_UPLOAD', 'Upload images');
if(!defined('_GALLERY_TEXT'))                  define('_GALLERY_TEXT', 'If you have an packed album (.zip), you can upload it to the directory then and convert it.');
if(!defined('_GALLERY_ZTITLE'))                define('_GALLERY_ZTITLE', 'Upload and install Package File');
if(!defined('_GALLERY_ZFILE'))                 define('_GALLERY_ZFILE', 'Package File (.zip)');
if(!defined('_GALLERY_POSTED'))                define('_GALLERY_POSTED', 'Uploaded on');
...
if(!defined('_GALLERY_LAST_SHOW'))             define('_GALLERY_LAST_SHOW', 'Show newest images in sidebar');
if(!defined('_GALLERY_LAST_SHOW_TITLE'))       define('_GALLERY_LAST_SHOW_TITLE', 'Show newest images title');
if(!defined('_GALLERY_LAST_MAX_IMG'))          define('_GALLERY_LAST_MAX_IMG', 'How many images');
if(!defined('_GALLERY_LAST_SIZE'))             define('_GALLERY_LAST_SIZE', 'Size of the images');
if(!defined('_GALLERY_LAST_TEXT'))             define('_GALLERY_LAST_TEXT', 'Text for the newest images');
if(!defined('_GALLERY_LAST_ALIGN'))            define('_GALLERY_LAST_ALIGN', 'Alignment for the newest images');
if(!defined('_GALLERY_LIST_NORMAL'))           define('_GALLERY_LIST_NORMAL', 'Normal imagelist (one below the other, with informationen)');
...
if(!defined('_PERSON_USERNAME'))               define('_PERSON_USERNAME', 'Username');
if(!defined('_PERSON_POSITION'))               define('_PERSON_POSITION', 'Position');
if(!defined('_PERSON_OCCUPATION'))             define('_PERSON_OCCUPATION', 'Occupation');
if(!defined('_PERSON_GROUP'))                  define('_PERSON_GROUP', 'Usergroup');
if(!defined('_PERSON_JOINDATE'))               define('_PERSON_JOINDATE', 'Joined');
if(!defined('_PERSON_RIGHTS'))                 define('_PERSON_RIGHTS', 'Userrights');
if(!defined('_PERSON_EMAIL'))                  define('_PERSON_EMAIL', 'eMail Adress');
if(!defined('_PERSON_PASSWORD'))               define('_PERSON_PASSWORD', 'Password');
if(!defined('_PERSON_AS_MD5'))                 define('_PERSON_AS_MD5', 'MD5 String');
if(!defined('_PERSON_VPASSWORD'))              define('_PERSON_VPASSWORD', 'Verify Password');
if(!defined('_PERSON_STREET'))                 define('_PERSON_STREET', 'Street');
if(!defined('_PERSON_STATE'))                  define('_PERSON_STATE', 'State');
if(!defined('_PERSON_TOWN'))                   define('_PERSON_TOWN', 'Town');
if(!defined('_PERSON_COUNTRY'))                define('_PERSON_COUNTRY', 'Country');
if(!defined('_PERSON_POSTAL'))                 define('_PERSON_POSTAL', 'Zip Code');
if(!defined('_PERSON_PHONE'))                  define('_PERSON_PHONE', 'Phone');
if(!defined('_PERSON_FAX'))                    define('_PERSON_FAX', 'Fax');
if(!defined('_PERSON_DETAILS'))                define('_PERSON_DETAILS', 'Your Details');
...
if(!defined('_PERSON_BIRTHDAY'))               define('_PERSON_BIRTHDAY', 'Birthday');
if(!defined('_PERSON_SEX'))                    define('_PERSON_SEX', 'Gender');
if(!defined('_PERSON_SEX_MAN'))                define('_PERSON_SEX_MAN', 'Male');
if(!defined('_PERSON_SEX_WOMAN'))              define('_PERSON_SEX_WOMAN', 'Female');
if(!defined('_PERSON_SEX_KA'))                 define('_PERSON_SEX_KA', 'No information');
if(!defined('_PERSON_TCMS_ENABLED'))           define('_PERSON_TCMS_ENABLED', 'toendaScript enabled');
if(!defined('_PERSON_SIGNATURE'))              define('_PERSON_SIGNATURE', 'Signature');
if(!defined('_PERSON_HOBBY'))                  define('_PERSON_HOBBY', 'Interests');
if(!defined('_PERSON_LOCATION'))               define('_PERSON_LOCATION', 'Residence');
if(!defined('_PERSON_LASTLOGIN'))              define('_PERSON_LASTLOGIN', 'Last login');


// SIDE EXTENSIONS
if(!defined('_SIDEEXT_SIDEMENU'))              define('_SIDEEXT_SIDEMENU', 'Sidemenu');
if(!defined('_SIDEEXT_SIDEMENU_TITLE'))        define('_SIDEEXT_SIDEMENU_TITLE', 'Sidemenu Title');
if(!defined('_SIDEEXT_SIDEMENU_SHOW'))         define('_SIDEEXT_SIDEMENU_SHOW', 'Show Sidemenu Title');
if(!defined('_SIDEEXT_SIDEBAR'))               define('_SIDEEXT_SIDEBAR', 'Sidebar');
if(!defined('_SIDEEXT_SIDEBAR_SHOW_TITLE'))    define('_SIDEEXT_SIDEBAR_SHOW_TITLE', 'Show sidebar title');
if(!defined('_SIDEEXT_SIDEBAR_TITLE'))         define('_SIDEEXT_SIDEBAR_TITLE', 'Sidebar title');
if(!defined('_SIDEEXT_SIDEBAR_SHOW'))          define('_SIDEEXT_SIDEBAR_SHOW', 'Show sidebar');
if(!defined('_SIDEEXT_TC'))                    define('_SIDEEXT_TC', 'Template Chooser');
if(!defined('_SIDEEXT_TC_SHOW_TITLE'))         define('_SIDEEXT_TC_SHOW_TITLE', 'Show Template Chooser title');
if(!defined('_SIDEEXT_TC_TITLE'))              define('_SIDEEXT_TC_TITLE', 'Template Chooser title');
if(!defined('_SIDEEXT_TC_SHOW'))               define('_SIDEEXT_TC_SHOW', 'Show Template Chooser');
if(!defined('_SIDEEXT_SEARCH'))                define('_SIDEEXT_SEARCH', 'Site Search');
if(!defined('_SIDEEXT_SEARCH_SHOW_TITLE'))     define('_SIDEEXT_SEARCH_SHOW_TITLE', 'Show search title');
if(!defined('_SIDEEXT_SEARCH_TITLE'))          define('_SIDEEXT_SEARCH_TITLE', 'Search title');
if(!defined('_SIDEEXT_SEARCH_RESULT_TITLE'))   define('_SIDEEXT_SEARCH_RESULT_TITLE', 'Searchresult Titel');
if(!defined('_SIDEEXT_SEARCH_ALIGNMENT'))      define('_SIDEEXT_SEARCH_ALIGNMENT', 'Searchbox alignment');
if(!defined('_SIDEEXT_SEARCH_WITH_BR'))        define('_SIDEEXT_SEARCH_WITH_BR', 'Searchbutton under');
if(!defined('_SIDEEXT_SEARCH_WITH_BUTTON'))    define('_SIDEEXT_SEARCH_WITH_BUTTON', 'Show Searchbutton');
if(!defined('_SIDEEXT_SEARCH_WORD'))           define('_SIDEEXT_SEARCH_WORD', 'Searchword in searchfield');
if(!defined('_SIDEEXT_SEARCH_SHOW'))           define('_SIDEEXT_SEARCH_SHOW', 'Show Search');
if(!defined('_SIDEEXT_LOGIN'))                 define('_SIDEEXT_LOGIN', 'Login');
if(!defined('_SIDEEXT_LOGIN_TITLE'))           define('_SIDEEXT_LOGIN_TITLE', 'Login title');
if(!defined('_SIDEEXT_USERM_TITLE'))           define('_SIDEEXT_USERM_TITLE', 'Usermenu title');
if(!defined('_SIDEEXT_LOGIN_SHOW'))            define('_SIDEEXT_LOGIN_SHOW', 'Show Login');
if(!defined('_SIDEEXT_LOGIN_USER'))            define('_SIDEEXT_LOGIN_USER', 'Login field username');
if(!defined('_SIDEEXT_LOGIN_PASS'))            define('_SIDEEXT_LOGIN_PASS', 'Login field password');
if(!defined('_SIDEEXT_LOGIN_ACCOUNT'))         define('_SIDEEXT_LOGIN_ACCOUNT', 'Text for NO ACCOUNT');
if(!defined('_SIDEEXT_LOGIN_REG'))             define('_SIDEEXT_LOGIN_REG', 'Registration link');
if(!defined('_SIDEEXT_LOGIN_MENU'))            define('_SIDEEXT_LOGIN_MENU', 'Use usermenu');
if(!defined('_SIDEEXT_LOGIN_ALLOW'))           define('_SIDEEXT_LOGIN_ALLOW', 'Allow registration');
if(!defined('_SIDEEXT_LOGIN_SHOW_TITLE'))      define('_SIDEEXT_LOGIN_SHOW_TITLE', 'Show login title');
if(!defined('_SIDEEXT_LOGIN_SHOW_MEMBERLIST')) define('_SIDEEXT_LOGIN_SHOW_MEMBERLIST', 'Show memberlist');
if(!defined('_SIDEEXT_NEWS'))                  define('_SIDEEXT_NEWS', 'News');
if(!defined('_SIDEEXT_NEWS_CATEGORIES_SHOW'))  define('_SIDEEXT_NEWS_CATEGORIES_SHOW', 'Show News Categories');
if(!defined('_SIDEEXT_NEWS_ARCHIVES_SHOW'))    define('_SIDEEXT_NEWS_ARCHIVES_SHOW', 'Show News Archives');
if(!defined('_SIDEEXT_NEWS_CATEGORIES_AMOUNT_SHOW'))define('_SIDEEXT_NEWS_CATEGORIES_AMOUNT_SHOW', 'Show amount of news in categories');
if(!defined('_SIDEEXT_MODUL'))                 define('_SIDEEXT_MODUL', 'Modules');
if(!defined('_SIDEEXT_LANGUAGE_SELECTOR'))     define('_SIDEEXT_LANGUAGE_SELECTOR', 'Language Selector');


// NEWSLETTER
if(!defined('_NL_CONFIG'))                     define('_NL_CONFIG', 'Newsletter Configuration');
if(!defined('_NL_TITLE'))                      define('_NL_TITLE', 'Newsletter title');
if(!defined('_NL_SHOW_TITLE'))                 define('_NL_SHOW_TITLE', 'Show newsletter title');
if(!defined('_NL_TEXT'))                       define('_NL_TEXT', 'Newsletter text');
if(!defined('_NL_SUBMIT'))                     define('_NL_SUBMIT', 'Newsletter submit button');
if(!defined('_NL_SHOW'))                       define('_NL_SHOW', 'Use Newsletter');
if(!defined('_NL_SEND'))                       define('_NL_SEND', 'Send newsletter');
if(!defined('_NL_SUBJECT'))                    define('_NL_SUBJECT', 'Subject');
if(!defined('_NL_MESSAGE'))                    define('_NL_MESSAGE', 'Message');
if(!defined('_NL_USER'))                       define('_NL_USER', 'Show all newsletter users');
if(!defined('_NL_NEWUSER'))                    define('_NL_NEWUSER', 'Create new newsletter user.');
if(!defined('_NL_EDITUSER'))                   define('_NL_EDITUSER', 'Edit newsletter user.');
if(!defined('_NL_USERNAME'))                   define('_NL_USERNAME', 'your name here');
if(!defined('_NL_USEREMAIL'))                  define('_NL_USEREMAIL', 'your@email.here');
if(!defined('_NL_MAILMESSAGE'))                define('_NL_MAILMESSAGE', 'If you dont want the newsletter in the future, answer with');
if(!defined('_NL_CHECKSTRING'))                define('_NL_CHECKSTRING', 'PLEASE NO NEWSLETTER');
if(!defined('_NL_CHECKFORUNSUBSCRIBE'))        define('_NL_CHECKFORUNSUBSCRIBE', 'Check eMails for unsubscribing users');
...
// USER
if(!defined('_USER_TITLE'))                    define('_USER_TITLE', 'Show users');
if(!defined('_USER_TEXT'))                     define('_USER_TEXT', 'Here are all your user listed. Some of this are administration user.');
if(!defined('_USER_SELF'))                     define('_USER_SELF', 'Own Username');
if(!defined('_USER_ALL'))                      define('_USER_ALL', 'All User');


// CONTACTS
if(!defined('_CONTACT_TITLE'))                 define('_CONTACT_TITLE', 'Show contacts');
if(!defined('_CONTACT_TEXT'))                  define('_CONTACT_TEXT', 'Here are all your contacts listed. Some of this are shown at the contact page.');
if(!defined('_CONTACT_ADRESS_BOOK'))           define('_CONTACT_ADRESS_BOOK', 'Adress Book');
if(!defined('_CONTACT_ADRESS_EMAIL'))          define('_CONTACT_ADRESS_EMAIL', 'Contact email');
if(!defined('_CONTACT_SEND_A_EMAIL'))          define('_CONTACT_SEND_A_EMAIL', 'Send a eMail');
if(!defined('_CONTACT_DETAIL'))                define('_CONTACT_DETAIL', 'Contact details');
...
if(!defined('_GLOBAL_EMAIL'))                  define('_GLOBAL_EMAIL', 'Default eMail');
if(!defined('_GLOBAL_YEAR'))                   define('_GLOBAL_YEAR', 'Copyright year');
if(!defined('_GLOBAL_CHARSET'))                define('_GLOBAL_CHARSET', 'Charset');
if(!defined('_GLOBAL_LANG'))                   define('_GLOBAL_LANG', 'Administration Framework Language');
if(!defined('_GLOBAL_FRONT_LANG'))             define('_GLOBAL_FRONT_LANG', 'Website Language');
if(!defined('_GLOBAL_WYSIWYG'))                define('_GLOBAL_WYSIWYG', 'Use WYSIWYG-Editor');
...
if(!defined('_GLOBAL_SITE_NAVI_SIDE'))         define('_GLOBAL_SITE_NAVI_SIDE', 'Side Menu');
if(!defined('_GLOBAL_META'))                   define('_GLOBAL_META', 'Metadata for HTML Head');
if(!defined('_GLOBAL_METATAGS'))               define('_GLOBAL_METATAGS', 'Metadata');
if(!defined('_GLOBAL_DESCRIPTION'))            define('_GLOBAL_DESCRIPTION', 'Description');
if(!defined('_GLOBAL_CURRENCY'))               define('_GLOBAL_CURRENCY', 'Currency');
if(!defined('_GLOBAL_LEGAL_LINK_IN_FOOTER'))   define('_GLOBAL_LEGAL_LINK_IN_FOOTER', 'Show Legal link in footer');
if(!defined('_GLOBAL_ADMIN_LINK_IN_FOOTER'))   define('_GLOBAL_ADMIN_LINK_IN_FOOTER', 'Show Admin link in footer');
if(!defined('_GLOBAL_DEFAULT_FOOTER'))         define('_GLOBAL_DEFAULT_FOOTER', 'Show toendaCMS default footer');
if(!defined('_GLOBAL_ACTIVE_TOPMENU_LINKS'))   define('_GLOBAL_ACTIVE_TOPMENU_LINKS', 'Use CSS classes for active topmenu links');
if(!defined('_GLOBAL_FOOTER_TEXT'))            define('_GLOBAL_FOOTER_TEXT', 'Own website footer text');
...
if(!defined('_GLOBAL_MAIL_SERVER_SMTP'))       define('_GLOBAL_MAIL_SERVER_SMTP', 'Mailserver SMTP');
...
if(!defined('_GLOBAL_MAIL_USER'))              define('_GLOBAL_MAIL_USER', 'eMail username');
if(!defined('_GLOBAL_MAIL_PASSWORD'))          define('_GLOBAL_MAIL_PASSWORD', 'eMail password');
if(!defined('_GLOBAL_USE_STATISTICS'))         define('_GLOBAL_USE_STATISTICS', 'Use statistics');
if(!defined('_GLOBAL_USE_NEW_ADMINMENU'))      define('_GLOBAL_USE_NEW_ADMINMENU', 'Use new adminmenu');
if(!defined('_GLOBAL_SEO'))                    define('_GLOBAL_SEO', 'SEO URL');
if(!defined('_GLOBAL_SEO_ENABLED'))            define('_GLOBAL_SEO_ENABLED', 'SEO enabled');
...
// POLL
if(!defined('_POLL_MAINTITLE'))                define('_POLL_MAINTITLE', 'Poll Module');
if(!defined('_POLL_ALL_TITLE'))                define('_POLL_ALL_TITLE', 'All Polls');
if(!defined('_POLL_TITLE'))                    define('_POLL_TITLE', 'Pollmodule Title');
if(!defined('_POLL_SHOW_TITLE'))               define('_POLL_SHOW_TITLE', 'Show poll title');
if(!defined('_POLL_ALLPOLL_TITLES'))           define('_POLL_ALLPOLL_TITLES', 'All polls title');
if(!defined('_POLL_SHOW'))                     define('_POLL_SHOW', 'Show poll in sidebar');
if(!defined('_POLL_TITLE_SIDEMENU'))           define('_POLL_TITLE_SIDEMENU', 'Sidemenu');
if(!defined('_POLL_MENU_TITLE'))               define('_POLL_MENU_TITLE', 'Poll link title');
if(!defined('_POLL_MENU_SHOW'))                define('_POLL_MENU_SHOW', 'Show poll link');
if(!defined('_POLL_MENU_POS'))                 define('_POLL_MENU_POS', 'Which place');
if(!defined('_POLL_TITLE_TOPMENU'))            define('_POLL_TITLE_TOPMENU', 'Topmenu');
if(!defined('_POLL_VOTETEXT'))                 define('_POLL_VOTETEXT', 'Thank you for your voting.');
if(!defined('_POLL_RESULTTEXT'))               define('_POLL_RESULTTEXT', 'You have currently vote in this poll.');
if(!defined('_POLL_ALLPOLLS'))                 define('_POLL_ALLPOLLS', 'All Polls');
if(!defined('_POLL_RESULT'))                   define('_POLL_RESULT', 'Result');
if(!defined('_POLL_POLLS_INACTIVE'))           define('_POLL_POLLS_INACTIVE', 'Currently are no polls active.');
if(!defined('_POLL_SIDE_WIDTH'))               define('_POLL_SIDE_WIDTH', 'Width of Poll in sidebar');
if(!defined('_POLL_MAIN_WIDTH'))               define('_POLL_MAIN_WIDTH', 'Width of Poll in content');
if(!defined('_POLL_ANSWERS'))                  define('_POLL_ANSWERS', 'Answers');


// PATHWAY
if(!defined('_PATH_HOME'))                     define('_PATH_HOME', 'Home');
if(!defined('_PATH_REGISTRATION'))             define('_PATH_REGISTRATION', 'Registration');
if(!defined('_PATH_PROFILE'))                  define('_PATH_PROFILE', 'User Profile');
if(!defined('_PATH_POLLS'))                    define('_PATH_POLLS', 'All Polls');
if(!defined('_PATH_LOSTPW'))                   define('_PATH_LOSTPW', 'Lost your password?');
...
// LAYOUT
if(!defined('_LAYOUT_SELECT'))                 define('_LAYOUT_SELECT', 'Select');
if(!defined('_LAYOUT_NO'))                     define('_LAYOUT_NO', 'No.');
if(!defined('_LAYOUT_PATH'))                   define('_LAYOUT_PATH', 'Path');
if(!defined('_LAYOUT_NAME'))                   define('_LAYOUT_NAME', 'Name');
if(!defined('_LAYOUT_AUTOR'))                  define('_LAYOUT_AUTOR', 'Author');
if(!defined('_LAYOUT_URL'))                    define('_LAYOUT_URL', 'URL');
if(!defined('_LAYOUT_VERSION'))                define('_LAYOUT_VERSION', 'Version');
if(!defined('_LAYOUT_PREVIEW'))                define('_LAYOUT_PREVIEW', 'Preview');
if(!defined('_LAYOUT_CURRENT'))                define('_LAYOUT_CURRENT', 'Current Template');
if(!defined('_LAYOUT_COUNT'))                  define('_LAYOUT_COUNT', 'Installed Templates');
...
if(!defined('_LU_DIR'))                        define('_LU_DIR', 'Name of template directory');
if(!defined('_LU_FILE'))                       define('_LU_FILE', 'File');
if(!defined('_LU_ZTITLE'))                     define('_LU_ZTITLE', 'Upload and install Package File');
if(!defined('_LU_ZFILE'))                      define('_LU_ZFILE', 'Package File (.zip)');
if(!defined('_LU_UPLOAD'))                     define('_LU_UPLOAD', '');
if(!defined('_LU_UPLOAD_TEMPLATE'))            define('_LU_UPLOAD_TEMPLATE', 'Upload Template Files in directory');
if(!defined('_LU_UPLOAD_IMAGE'))               define('_LU_UPLOAD_IMAGE', 'Template pictures');
...
if(!defined('_LU_THUMB'))                      define('_LU_THUMB', 'Screenshot with width');
if(!defined('_LU_DES_TEXT'))                   define('_LU_DES_TEXT', 'Please fill all fields with a full bullet.');
if(!defined('_LU_DES_DIR'))                    define('_LU_DES_DIR', 'Dir to save the file');
if(!defined('_LU_DES_NAME'))                   define('_LU_DES_NAME', 'Template Name');
if(!defined('_LU_DES_AUTOR'))                  define('_LU_DES_AUTOR', 'Author Name');
if(!defined('_LU_DES_URL'))                    define('_LU_DES_URL', 'URL of the Author\'s Website');
if(!defined('_LU_DES_VERSION'))                define('_LU_DES_VERSION', 'Version of your Template');
...
if(!defined('_CREDITS_RELEVANT'))              define('_CREDITS_RELEVANT', 'Relevent for the Content Management System');
if(!defined('_CREDITS_VERSION'))               define('_CREDITS_VERSION', 'toendaCMS Version');
if(!defined('_CREDITS_PLATFORM'))              define('_CREDITS_PLATFORM', 'Platform');
...
if(!defined('_CREDITS_SERVER_FACE'))           define('_CREDITS_SERVER_FACE', 'Webserver to PHP interface');
if(!defined('_CREDITS_RELEVANT_SET'))          define('_CREDITS_RELEVANT_SET', 'Relevent PHP Settings');
if(!defined('_CREDITS_SET_GLOBALS'))           define('_CREDITS_SET_GLOBALS', 'Register Globals');
if(!defined('_CREDITS_SET'))                   define('_CREDITS_SET', 'enabled');
if(!defined('_CREDITS_PHP_MODULES'))           define('_CREDITS_PHP_MODULES', 'PHP Modules');


// ABOUT MOD
if(!defined('_ABOUTMOD_TITLE'))                define('_ABOUTMOD_TITLE', 'This is a small description af the modules');
if(!defined('_ABOUTMOD_MODULE'))               define('_ABOUTMOD_MODULE', 'Module');
if(!defined('_ABOUTMOD_DESCRIPTION'))          define('_ABOUTMOD_DESCRIPTION', 'Description');
...
if(!defined('_FORM_MESSAGE'))                  define('_FORM_MESSAGE', 'Message');
if(!defined('_FORM_URL'))                      define('_FORM_URL', 'Website');
if(!defined('_FORM_SUBJECT'))                  define('_FORM_SUBJECT', 'Subject');
if(!defined('_FORM_MSG'))                      define('_FORM_MSG', 'Message');
if(!defined('_FORM_COPY'))                     define('_FORM_COPY', 'Please send me a copy');
if(!defined('_FORM_SEND'))                     define('_FORM_SEND', 'Send');
if(!defined('_FORM_SUBMIT'))                   define('_FORM_SUBMIT', 'Submit');
if(!defined('_FORM_MSG_CONTENT'))              define('_FORM_MSG_CONTENT', 'Follow message send from the Contactform at');
if(!defined('_FORM_DEAR'))                     define('_FORM_DEAR', 'Dear');
if(!defined('_FORM_THANKYOU'))                 define('_FORM_THANKYOU', 'thank you for your visit an our website!');
if(!defined('_FORM_FOLLOWMSG'))                define('_FORM_FOLLOWMSG', 'Follow message is send from the Contactform:');
if(!defined('_FORM_YOUR'))                     define('_FORM_YOUR', 'Your');
if(!defined('_FORM_CFORM'))                    define('_FORM_CFORM', 'Contactform');
if(!defined('_FORM_SYSTEM'))                   define('_FORM_SYSTEM', 'This is a system generated message, please do not aswer.');
if(!defined('_FORM_GREETS'))                   define('_FORM_GREETS', 'With kind regards');
if(!defined('_FORM_FROM'))                     define('_FORM_FROM', 'This Newsletter is from ');
...
if(!defined('_NEWS_DATE'))                     define('_NEWS_DATE', 'Date');
if(!defined('_NEWS_TIME'))                     define('_NEWS_TIME', 'Time');
if(!defined('_NEWS_SAMPLE'))                   define('_NEWS_SAMPLE', 'Sample');
if(!defined('_NEWS_MAINTEXT'))                 define('_NEWS_MAINTEXT', 'News Text');
if(!defined('_NEWS_IMAGE_HELP'))               define('_NEWS_IMAGE_HELP', 'Click on the buttons over me to put a news frontpage stop, a linebreak and images into your text.');
if(!defined('_NEWS_TCMS_HELP'))                define('_NEWS_TCMS_HELP', 'Copy this tags into the text at the place you want.');
if(!defined('_NEWS_IMAGES'))                   define('_NEWS_IMAGES', 'News Image');
if(!defined('_NEWS_IMAGE'))                    define('_NEWS_IMAGE', 'Image');
if(!defined('_NEWS_DIR'))                      define('_NEWS_DIR', 'Directory');
if(!defined('_NEWS_ARCHIVE'))                  define('_NEWS_ARCHIVE', 'Archive');
if(!defined('_NEWS_ALL'))                      define('_NEWS_ALL', 'All');
if(!defined('_NEWS_LAST'))                     define('_NEWS_LAST', 'last');
if(!defined('_NEWS_ORDER_BY_TIME'))            define('_NEWS_ORDER_BY_TIME', 'order by time');
if(!defined('_NEWS_ORDER_BY_CAT'))             define('_NEWS_ORDER_BY_CAT', 'order by categories');
if(!defined('_NEWS_CATEGORIES_TITLE'))         define('_NEWS_CATEGORIES_TITLE', 'News Categories');
if(!defined('_NEWS_ARCHIVES_TITLE'))           define('_NEWS_ARCHIVES_TITLE', 'News Archives');
if(!defined('_NEWS_CATEGORIES_TEXT'))          define('_NEWS_CATEGORIES_TEXT', 'You can create and edit your news categories here.');
if(!defined('_NEWS_IN'))                       define('_NEWS_IN', 'in');
if(!defined('_NEWS_CATEGORY_ARCHIV'))          define('_NEWS_CATEGORY_ARCHIV', 'Archive for the Category');
if(!defined('_NEWS_ARCHIV_FOR'))               define('_NEWS_ARCHIV_FOR', 'Archive for');
...
// FRONTPAGE
if(!defined('_FRONTPAGE_CONFIG'))              define('_FRONTPAGE_CONFIG', 'Frontpage Configuration');
if(!defined('_FRONTPAGE_USE'))                 define('_FRONTPAGE_USE', 'Use Frontpage');
if(!defined('_FRONTPAGE_ID'))                  define('_FRONTPAGE_ID', 'ID (if you use the frontpage, ID is 0)');
if(!defined('_FRONTPAGE_TITLE'))               define('_FRONTPAGE_TITLE', 'Frontpage title');
if(!defined('_FRONTPAGE_SUBTITLE'))            define('_FRONTPAGE_SUBTITLE', 'Frontpage subtitle');
if(!defined('_FRONTPAGE_TEXT'))                define('_FRONTPAGE_TEXT', 'Frontpage text');
if(!defined('_FRONTPAGE_NEWS'))                define('_FRONTPAGE_NEWS', 'News');
if(!defined('_FRONTPAGE_NEWS_TITLE'))          define('_FRONTPAGE_NEWS_TITLE', 'News title');
if(!defined('_FRONTPAGE_NEWS_MUCH'))           define('_FRONTPAGE_NEWS_MUCH', 'How much news at the frontpage?');
if(!defined('_FRONTPAGE_NEWS_CHARS'))          define('_FRONTPAGE_NEWS_CHARS', 'How much characters in this news?');
if(!defined('_FRONT_MORE'))                    define('_FRONT_MORE', 'Read more');
if(!defined('_FRONT_COMMENT'))                 define('_FRONT_COMMENT', 'Comment');
if(!defined('_FRONT_COMMENTS'))                define('_FRONT_COMMENTS', 'Comments');
if(!defined('_FRONT_NOCOMMENT'))               define('_FRONT_NOCOMMENT', 'No comments posted!');
if(!defined('_FRONT_COMMENT_TITLE'))           define('_FRONT_COMMENT_TITLE', 'Post new comment');
...
if(!defined('_FRONT_COMMENT_WEB'))             define('_FRONT_COMMENT_WEB', 'Website');
if(!defined('_FRONT_COMMENT_TEXT'))            define('_FRONT_COMMENT_TEXT', 'Message');
if(!defined('_FRONT_COMMENT_POST'))            define('_FRONT_COMMENT_POST', 'Posted by');
if(!defined('_FRONT_OWN_TRACKBACK'))           define('_FRONT_OWN_TRACKBACK', 'Own Trackback URL');
if(!defined('_FRONT_TRACKBACK_URL'))           define('_FRONT_TRACKBACK_URL', 'Trackback Target URL');
if(!defined('_FRONTPAGE_SIDEBAR_NEWS'))        define('_FRONTPAGE_SIDEBAR_NEWS', 'Sidebar News');
if(!defined('_FRONTPAGE_SIDEBAR_NEWS_USE'))    define('_FRONTPAGE_SIDEBAR_NEWS_USE', 'Show news in sidebar');
if(!defined('_FRONTPAGE_SIDEBAR_NEWS_TITLE'))  define('_FRONTPAGE_SIDEBAR_NEWS_TITLE', 'Sidebar News title');
if(!defined('_FRONTPAGE_SIDEBAR_NEWS_MUCH'))   define('_FRONTPAGE_SIDEBAR_NEWS_MUCH', 'How much news at the frontpage in the sidebar?');
if(!defined('_FRONTPAGE_NEWS_DISPLAY'))        define('_FRONTPAGE_NEWS_DISPLAY', 'How to display the news in sidebar?');
...
if(!defined('_SEARCH_SUBMIT'))                 define('_SEARCH_SUBMIT', 'Search');
if(!defined('_SEARCH_BOX'))                    define('_SEARCH_BOX', 'Searchword');
if(!defined('_SEARCH_TEXT_FOUND'))             define('_SEARCH_TEXT_FOUND', 'Searchresult:');
if(!defined('_SEARCH_EMPTY'))                  define('_SEARCH_EMPTY', 'You cannot search for nothing. Please enter a searchword.');
if(!defined('_SEARCH_START'))                  define('_SEARCH_START', 'Enter your searchword.');
...
// FILESYSTEMS
if(!defined('_FOLDER_DEFAULT'))                define('_FOLDER_DEFAULT', 'Default');
if(!defined('_FOLDER_HTML'))                   define('_FOLDER_HTML', 'HTML');
if(!defined('_FOLDER_IMAGES'))                 define('_FOLDER_IMAGES', 'Images');
if(!defined('_FOLDER_LOCKED'))                 define('_FOLDER_LOCKED', 'Locked');
if(!defined('_FOLDER_PACK'))                   define('_FOLDER_PACK', 'Packages');
if(!defined('_FOLDER_PRINT'))                  define('_FOLDER_PRINT', 'Print');
if(!defined('_FOLDER_SOUND'))                  define('_FOLDER_SOUND', 'Sound');
if(!defined('_FOLDER_DOCU'))                   define('_FOLDER_DOCU', 'Documents');
if(!defined('_FOLDER_VID'))                    define('_FOLDER_VID', 'Video');


// FILESYSTEMS
if(!defined('_DB_CHOOSE'))                     define('_DB_CHOOSE', 'Database engine for toendaCMS');
if(!defined('_DB_USER'))                       define('_DB_USER', 'SQL Server Username');
if(!defined('_DB_PASSWORD'))                   define('_DB_PASSWORD', 'SQL Server Password');
if(!defined('_DB_HOST'))                       define('_DB_HOST', 'SQL Server Host');
if(!defined('_DB_DATABASE'))                   define('_DB_DATABASE', 'SQL Server Database');
if(!defined('_DB_PORT'))                       define('_DB_PORT', 'SQL Server Port (related for PostgreSQL Server)');
...
if(!defined('_DB_OPTIMIZATION'))               define('_DB_OPTIMIZATION', 'Optimize Database');
if(!defined('_DB_RESTORE'))                    define('_DB_RESTORE', 'Restore Database');
if(!defined('_DB_START_BACKUP'))               define('_DB_START_BACKUP', 'Start now backup');
if(!defined('_DB_START_OPTIMIZATION'))         define('_DB_START_OPTIMIZATION', 'Start now optimization');
if(!defined('_DB_START_RESTORE'))              define('_DB_START_RESTORE', 'Start now restore');
if(!defined('_DB_CONFIG'))                     define('_DB_CONFIG', 'Configuration Database');
if(!defined('_DB_BACKUP_RESTORE'))             define('_DB_BACKUP_RESTORE', 'Database Backup &amp; Restore');
if(!defined('_DB_BACKUP_OPTIMIZATION'))        define('_DB_BACKUP_OPTIMIZATION', 'Database Optimization');
...
// LINKS
if(!defined('_LINK_MODULE'))                   define('_LINK_MODULE', 'Link Manager configuration');
if(!defined('_LINK_MODULE_TITLE'))             define('_LINK_MODULE_TITLE', 'Link Manager');
if(!defined('_LINK_MODULE_DESC'))              define('_LINK_MODULE_DESC', 'You can create links and linkcategories here. Please consider that each link must integrate into a category..');
if(!defined('_LINK_USE_SIDELINKS'))            define('_LINK_USE_SIDELINKS', 'Show links in sidebar');
if(!defined('_LINK_USE_SIDELINKS_DESC'))       define('_LINK_USE_SIDELINKS_DESC', 'Show link description in sidebar');
if(!defined('_LINK_USE_SIDELINKS_TITLE'))      define('_LINK_USE_SIDELINKS_TITLE', 'Show title for the sidebar links');
if(!defined('_LINK_SIDELINKS_TITLE'))          define('_LINK_SIDELINKS_TITLE', 'Title for the sidebar links');
if(!defined('_LINK_MAINLINKS_TITLE'))          define('_LINK_MAINLINKS_TITLE', 'Title for the content page');
if(!defined('_LINK_MAINLINKS_SUBTITLE'))       define('_LINK_MAINLINKS_SUBTITLE', 'Subtitle for the content page');
if(!defined('_LINK_MAINLINKS_TEXT'))           define('_LINK_MAINLINKS_TEXT', 'Text for the content page');
if(!defined('_LINK_USE_MAINLINKS_DESC'))       define('_LINK_USE_MAINLINKS_DESC', 'Show link description in content page');
if(!defined('_LINK_WICH_MODULE'))              define('_LINK_WICH_MODULE', 'Show link in this module');
...
if(!defined('_STATS_PAGE'))                    define('_STATS_PAGE', 'Page');
if(!defined('_STATS_COUNT'))                   define('_STATS_COUNT', 'Counter');
if(!defined('_STATS_SUM_CLICKS'))              define('_STATS_SUM_CLICKS', 'Sum of all hits');
if(!defined('_STATS_SUM_UNIQUE'))              define('_STATS_SUM_UNIQUE', 'Sum of all unique hits');
if(!defined('_STATS_SUM_IP'))                  define('_STATS_SUM_IP', 'Sum of different ip adresses');
if(!defined('_STATS_BROWSER_OS'))              define('_STATS_BROWSER_OS', 'Browser, OS');
if(!defined('_STATS_HITS'))                    define('_STATS_HITS', 'Hits, Page Impressions, Referrers');
if(!defined('_STATS_BROWSER'))                 define('_STATS_BROWSER', 'Browser');
if(!defined('_STATS_OS'))                      define('_STATS_OS', 'Operating System');
if(!defined('_STATS_RESET'))                   define('_STATS_RESET', 'Reset statistics');
...
if(!defined('_CS_UPLOAD_ZTITLE'))              define('_CS_UPLOAD_ZTITLE', 'Upload and install Package File');
...
if(!defined('_LANG_GALICIAN'))                 define('_LANG_GALICIAN', 'Galician');
...
if(!defined('_COUNTRY_LIBYA'))                 define('_COUNTRY_LIBYA', 'Libya');
if(!defined('_COUNTRY_LIECHTENSTEIN'))         define('_COUNTRY_LIECHTENSTEIN', 'Liechtenstein');
if(!defined('_COUNTRY_LITHUANIA'))             define('_COUNTRY_LITHUANIA', 'Lithuania');
if(!defined('_COUNTRY_LUXEMBOURG'))            define('_COUNTRY_LUXEMBOURG', 'Luxembourg');
...
if(!defined('_COUNTRY_MALDIVEISLANDS'))        define('_COUNTRY_MALDIVEISLANDS', 'Maldive Islands');
...
if(!defined('_COUNTRY_NEW_CALEDONIA'))         define('_COUNTRY_NEW_CALEDONIA', 'New Caledonia');
if(!defined('_COUNTRY_NEW_ZEALAND'))           define('_COUNTRY_NEW_ZEALAND', 'New Zealand');
if(!defined('_COUNTRY_NICARAGUA'))             define('_COUNTRY_NICARAGUA', 'Nicaragua');
if(!defined('_COUNTRY_NETHERLANDS'))           define('_COUNTRY_NETHERLANDS', 'Netherlands');
if(!defined('_COUNTRY_NETHERLANDS_ANTILLES'))  define('_COUNTRY_NETHERLANDS_ANTILLES', 'The Netherlands Antilles');
...
if(!defined('_COUNTRY_NORTH_KOREA'))           define('_COUNTRY_NORTH_KOREA', 'North Korea');
if(!defined('_COUNTRY_NORFOLK_ISLANDS'))       define('_COUNTRY_NORFOLK_ISLANDS', 'Norfolk Islands');
if(!defined('_COUNTRY_NORWAY'))                define('_COUNTRY_NORWAY', 'Norway');
if(!defined('_COUNTRY_MARIANA_ISLANDS'))       define('_COUNTRY_MARIANA_ISLANDS', 'Mariana Islands');
...
if(!defined('_COUNTRY_SWEDEN'))                define('_COUNTRY_SWEDEN', 'Sweden');
if(!defined('_COUNTRY_SOUTHAFRICA'))           define('_COUNTRY_SOUTHAFRICA', 'South Africa');
if(!defined('_COUNTRY_SOUTHKOREA'))            define('_COUNTRY_SOUTHKOREA', 'Sweden');
if(!defined('_COUNTRY_SYRIA'))                 define('_COUNTRY_SYRIA', 'Syria');
