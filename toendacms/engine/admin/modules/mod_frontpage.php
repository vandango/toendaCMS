...
if($id_group == 'Developer' || $id_group == 'Administrator'){
	...
	if($choosenDB == 'xml'){
		$front_xml = new xmlparser('../../'.$tcms_administer_site.'/tcms_global/frontpage.xml','r');
		...
		$sqlQR = $sqlAL->sqlGetOne($tcms_db_prefix.'frontpage', 'frontpage');
		$sqlARR = $sqlAL->sqlFetchArray($sqlQR);
		
		$old_front_id        = $sqlARR['front_id'];
		$old_front_title     = $sqlARR['front_title'];
		$old_front_stamp     = $sqlARR['front_stamp'];
		$old_front_text      = $sqlARR['front_text'];
		$old_news_title      = $sqlARR['news_title'];
		$old_news_cut        = $sqlARR['news_cut'];
		$old_module_use_0    = $sqlARR['module_use_0'];
		$old_sb_news_title   = $sqlARR['sb_news_title'];
		$old_sb_module_use_0 = $sqlARR['sb_news_amount'];
		$old_sb_news_cut     = $sqlARR['sb_news_chars'];
		$old_sb_enabled      = $sqlARR['sb_news_enabled'];
		$old_sb_display      = $sqlARR['sb_news_display'];
	...
	if($todo == 'config'){
		...
		echo '<th valign="middle" align="left" class="tcms_db_title tcms_padding_mini">'._FRONTPAGE_NEWS.'</th>';
		echo '</tr></table>';
		...
		// table rows
		echo '<tr><td class="tcms_padding_mini" width="250" valign="top">'._FRONTPAGE_NEWS_TITLE.'</td>'
		...
		// table rows
		echo '<tr><td class="tcms_padding_mini" width="250" valign="top">'._FRONTPAGE_NEWS_MUCH.'</td>'
		.'<td valign="top"><img src="../images/bullet_1.gif" border="0" style="margin: 5px 2px 0 0 !important;" />'
		...
		// table rows
		echo '<tr><td class="tcms_padding_mini" width="250" valign="top">'._FRONTPAGE_NEWS_CHARS.'</td>'
		.'<td valign="top"><img src="../images/bullet_1.gif" border="0" style="margin: 5px 2px 0 0 !important;" />'
		...
		// frontpage news settings
		echo '<table width="100%" cellpadding="0" cellspacing="0" class="tcms_noborder"><tr class="tcms_bg_blue_01">';
		echo '<th valign="middle" align="left" class="tcms_db_title tcms_padding_mini">'._FRONTPAGE_SIDEBAR_NEWS.'</th>';
		echo '</tr></table>';
		...
		// table rows
		echo '<tr><td class="tcms_padding_mini" width="250" valign="top">'._FRONTPAGE_SIDEBAR_NEWS_USE.'</td>'
		.'<td valign="top"><img src="../images/bullet_1.gif" border="0" style="margin: 5px 2px 0 0 !important;" />'
		...
		// table rows
		echo '<tr><td class="tcms_padding_mini" width="250" valign="top">'._FRONTPAGE_SIDEBAR_NEWS_TITLE.'</td>'
		.'<td valign="top"><img src="../images/bullet_1.gif" border="0" style="margin: 5px 2px 0 0 !important;" />'
		...
		// table rows
		echo '<tr><td class="tcms_padding_mini" width="250" valign="top">'._FRONTPAGE_SIDEBAR_NEWS_MUCH.'</td>'
		.'<td valign="top"><img src="../images/bullet_1.gif" border="0" style="margin: 5px 2px 0 0 !important;" />'
		...
		// table row
		echo '<tr><td class="tcms_padding_mini">'._FRONTPAGE_NEWS_DISPLAY.'</td>'
		.'<td><img src="../images/bullet_1.gif" border="0" vspace="4" /><img src="../images/px.png" border="0" width="1" />'
		...
		echo '<table width="100%" cellpadding="0" cellspacing="0" class="tcms_noborder"><tr class="tcms_bg_blue_01">';
		echo '<th valign="top" align="left" class="tcms_db_title tcms_padding_mini">'._FRONTPAGE_CONFIG.'</th>';
		echo '</tr></table>';
		...
		// table rows
		echo '<tr><td class="tcms_padding_mini" width="250" valign="top">'._FRONTPAGE_TITLE.'</td>'
		.'<td valign="top"><img src="../images/bullet_1.gif" border="0" style="margin: 5px 2px 0 0 !important;" />'
		...
		// table rows
		echo '<tr><td class="tcms_padding_mini" width="250" valign="top">'._FRONTPAGE_SUBTITLE.'</td>'
		.'<td valign="top"><img src="../images/bullet_1.gif" border="0" style="margin: 5px 2px 0 0 !important;" />'
		...
		// table rows
		echo '<table width="100%" cellpadding="0" cellspacing="0" class="tcms_noborder"><tr class="tcms_bg_blue_01">';
		echo '<th valign="top" align="left" class="tcms_db_title tcms_padding_mini">'._FRONTPAGE_TEXT.'</th>';
		echo '</tr></table>';
	...
	if($todo == 'save'){
		...
		if($choosenDB == 'xml'){
			$xmluser = new xmlparser('../../'.$tcms_administer_site.'/tcms_global/frontpage.xml', 'w');
			...
			$sqlQR = $sqlAL->sqlUpdateOne($tcms_db_prefix.'frontpage', $newSQLData, 'frontpage');
		}
		
		//***************************************
		
		if($extra == 1){
			echo '<script>document.location=\'admin.php?id_user='.$id_user.'&site=mod_frontpage&todo=config\'</script>';
		}
		else{
			echo '<script>document.location=\'admin.php?id_user='.$id_user.'&site=mod_frontpage\'</script>';
		}
