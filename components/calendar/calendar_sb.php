...
while($i <= $cal_mainDate){
	...
	if($i == $cal_today) echo '<td style="background: #'.$cs_currentday_backcolor.';" align="center" class="text_normal">';
	else echo '<td class="text_normal" '.( $cal_cnt != 0 ? 'style="background: #'.$cs_day_with_event.';" ' : '' ).'align="center">';
