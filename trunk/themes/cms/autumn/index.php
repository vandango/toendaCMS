<!--
|----------------------------------------|
|Themeportal | Load Themes for Toendacms |
|       http://Themeportal.de            |
|----------------------------------------|
-->
...
<link href="<? echo $skinPath; ?>autumn.css" rel="stylesheet" type="text/css" />
...
<!-- Theme by Themeportal.de - http://themeportal.de/ -->
<!-- Layout based on Kubrick of Michael Heilemann - http://binarybonsai.com/kubrick/ -->
